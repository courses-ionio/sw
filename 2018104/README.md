...
* Έχω ανεβάσει και διάφορα αρχεία όπως άδειες από το template γιατί δεν ήξερα αν πρέπει να τα αφήσω ή να τα διαγράψω 
* Για την μεταφορά των αρχείων χρησιμοποίησα την εντολή docker cp SOURCE DESTINATION γιατί το  /mnt εμφανίζεται άδειο και έπρεπε να βρω άλλη λύση 
...
Τελικό Αποτέλεσμα : [CV KERASIDOU GEWRGIA](https://giouliker.github.io/CV_KERASIDOU/)<br>
Έπειτα έκανα το ίδιο και στο repository (cv-1)[https://github.com/giouliker/cv-1] που είχαμε φτιάξει στο εργαστήριο και οι διαφορές  ήταν πως έβλεπα τις αλλαγές τοπικά με bundle exec jekyll serve 
και ότι στο τέλος έπρεπε να βάλω την επιλογή --force για να κάνω το push. To [αποτέλεσμα](https://giouliker.github.io/cv-1/) είναι το ίδιο.

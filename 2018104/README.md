...
Μετά το τέλος των παραδοτέων και των μαθημάτων έχω αποκομίσει πολλές νέες γνώσεις τόσο από την ενεργή ενασχόληση με τα παραδοτέα όσο από τα μαθήματα και κυρίως τα video quiz 

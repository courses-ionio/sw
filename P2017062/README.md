...
### [Προσωπική ιστοσελίδα του βιβλίου του μαθήματος](https://priceless-bhabha-93759e.netlify.app/)

#### Β) Προσθήκη ένος νέου διαδραστικού παραδείγματος, το οποίο συνδέεται με βασικές έννοιες του βιβλίου και της διάδρασης ανθρώπου-υπολογιστή και επιτρέπει σε 2ο χρήστη να το αλλάξει ή/και να το προσθέσει σε διαφορετικές εφαρμογές ως αρχέτυπο.

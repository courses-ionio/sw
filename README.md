...
| Εβδομάδα* | Παραδοτέο | Σύνδεσμος στην [εβδομαδιαία παρουσίαση προόδου στις συζητήσεις](https://github.com/courses-ionio/sw/discussions/categories/show-and-tell) | Σύντομη αυτοαξιολόγηση σύμφωνα με τα κριτήρια της αντίστοιχης άσκησης και αναμενόμενος βαθμός |
| --- | --- | --- | --- |
| 1 | [Φορκ του αποθετηρίου και δημιουργία της σελίδας](https://courses-ionio.github.io/help/guide/) της αναφοράς με τα προσωπικά στοιχεία σας (Όνομα, ΑΜ, github profile), της σύνοψης με αυτόν τον [πίνακα περιεχομένων](https://courses-ionio.github.io/help/deliverables/), και συγγραφή της εισαγωγής με περιγραφή των αναγκών και των στόχων σας για το αντίστοιχο μάθημα* | | |
| 2 | βιογραφικό | | |

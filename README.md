...
Το μάθημα αυτό είναι ελεύθερης επιλογής προχωρημένου εξαμήνου και έχει ως προαπαιτούμενο την άριστη επίδοση (8-9-10) στα προηγούμενα μαθήματα της Επικοινωνίας Ανθρώπου-Υπολογιστή (hci) και των συνεργατικών συστημάτων (cscw). 

...
>> Η συμπλήρωση της εβδομάδας ορίζεται ως η μέρα πριν το επόμενο μάθημα, π.χ., για την 1η εβδομάδα η παράδοση είναι την ημέρα πριν το 2ο μάθημα. Η 1η και η 10η εβδομάδα είναι σημαντικές γιατί αξιολογούμε κυρίως την συστηματική προσπάθεια και όχι κάποιο προκαθορισμένο επίπεδο γνώσεων και δεξιοτήτων.
...
**Κριτήρια βαθμολογίας:**  10% [Συμμετοχικό εκπαιδευτικό περιεχόμενο](https://courses-ionio.github.io/help/social/) + 10% [κατασκευή του βιβλίου](https://courses-ionio.github.io/help/book) + 30% [ομαδικότητα και συνεργασία](https://courses-ionio.github.io/help/teamwork/) + 50% [συμμετοχή στην τάξη](https://courses-ionio.github.io/help/classroom/)

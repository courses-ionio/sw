...
| --- | --- | --- | --- |
| 1 | [ΓΕΩΡΓΙΟΣ ΒΡΟΥΖΟΣ Π2019026), [Οι στόχοι μου για το μάθημα είναι να ολοκληρώσω με επιτυχία τα παραδοτέα του μαθήματος, έτσι ώστε να μπορέσω να αποκτήσω νέες γνώσεις. Ακόμα θα ήθελα να εξοικειωθώ ακόμα περισσότερο με την πλατφόρμα GitHub καθώς και με τα υπόλοιπα εργαλεία που θα χρειαστεί να χρησιμοποιήσω. Τέλος πιστεύω πως αυτό το μάθημα θα με βοηθήσει σε ανθρωπιστικους και κοινωνικούς τομείς, μέσω των ομαδικών εργασιών και των εβδομαδιαίων συζητήσεων. ],Σύνδεσμος συζήτησης δίπλα --> https://github.com/courses-ionio/help/discussions/143 
| 2 | https://p19vrou.github.io/online-cv/ | | |

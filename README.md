...
Το μάθημα αυτό είναι ελεύθερης επιλογής προχωρημένου εξαμήνου και έχει ως προαπαιτούμενο την άριστη επίδοση (8-9-10) στα προηγούμενα μαθήματα της Επικοινωνίας Ανθρώπου-Υπολογιστή (hci) και των συνεργατικών συστημάτων (cscw). Φυσικά μπορείτε να πάρετε το μάθημα και χωρίς τα προαπαιτούμενα, τα οποία όμως έχουν γνώσεις και δεξιότητες που θεωρούνται γνωστά σε αυτό το μάθημα.

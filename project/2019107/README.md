...
| 7 | συμμετοχικό περιεχόμενο B1 |https://github.com/courses-ionio/sw/discussions/1570| Στο συμμετοχικό περιεχόμενο Β1 πραγματοποιήθηκε μελέτη περίπτωσης σχετικά με τα cgroups των linux  |
...
| 9 | συμμετοχικό περιεχόμενο B2 |https://github.com/courses-ionio/sw/discussions/1572 |Έγινε προσθήκη συνεισφοράς σχετικά με την βιογραφία του Lennart Poettering|

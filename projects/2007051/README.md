...
1) Περιγραφή των αναγκών και των στόχων για το μάθημα | ✔️ (100%) 
2) βιογραφικό: Σελίδα με jekyll | ✔️ (100%)
3) Προσθήκη ανακοίνωσης | ✔️ (100%)
4) create your own static site and blog generator | ✔️ (100%)
5) Συμμετοχικό περιεχόμενο: A1 & A2 | ✔️ (100%)
6) send notifications to your desktop-mobile | ✔️ (100%)
7) βιογραφικό: PDF με pandoc & latex | ✔️ (100%)
8) Προσθήκη μαθήματος Η' εξαμήνου | ✔️ (80%)
9) create notifications on your server | ✔️ (100%)
10) Συμμετοχικό περιεχόμενο: Β1 & Β2 | ✔️ (80%)
11) performance monitoring | ✔️ (100%)
12) Τελική αναφορά | ✔️ (100%)

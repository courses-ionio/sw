...
Έχοντας παραδώσει συνολικά όλα τα παραδοτέα στην επαναληπτική εξεταστική του Σεπτεμβρίου, εξοικειώθηκα σε μεγάλο βαθμό τόσο με την πλατφόρμα του Github όσο και με την χρήση Linux Terminal (με το εργαλείο Oracle VM Virtualbox) και ήρθα σε επαφή για πρώτη φορά με το σημαντικό εργαλείο Asciinema.
Στο σύνολό τους τα παραδοτέα με βοήθησαν να αναπτύξω σημαντικές δεξιότητες για την μετέπειτα πορεία μου στην αγορά εργασίας, με γνώσεις που έλαβα και χρησιμοποίησα απ'ευθείας πρακτικά στις διάφορες εργασίες που ανέλαβα. Η δομή του μαθήματος ήταν άκρως ενδιαφέρουσα καθώς τα εβδομαδιαία παραδοτέα βοήθησαν στην σταδιακή αφομοίωση και χρήση των εν λόγω γνώσεων. Τέλος, θέλω να ευχαριστήσω τον καθηγητή και βοηθούς του μαθήματος για τη διδασκαλία και την άμεση ανταπόκριση, καθώς όταν χρειάστηκα την οποιαδήποτε βοήθεια/οδηγία σχετικά με την εκπόνηση των παραδοτέων, με εξυπηρέτησαν άμεσα.

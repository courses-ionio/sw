...
Terminal (με το εργαλείο **Oracle VM Virtualbox**), ήρθα σε επαφή για πρώτη φορά με το εργαλείο **Asciinema** για καταγραφή terminal, καθώς και το **Netlify** για deploy του προσωπικού μου site.

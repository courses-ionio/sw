...
Το μάθημα "Τεχνολογία Λογισμικού" θεωρώ ότι θα συνδράμει στο να είμαι ως φοιτητής του τμήματος μέρος μιας προσπάθειας προσέγγισης στους τομείς της ανάλυσης, του σχεδιασμού και της δημιουργίας ενός λογισμικού. Με τη χρήση του github πιστεύω πως η τηλε-εκπαίδευση θα είναι υψηλού επιπέδου, δημιουργώντας την αίσθηση της ομάδας και της συνεργατικότητας. Παράλληλα, θα αναπτυχθούν οι δεξιότητες μου στους τομείς του προγραμματισμού εφαρμογών μέσω των ασκήσεων με εντολές σε τερματικό περιβάλλον.

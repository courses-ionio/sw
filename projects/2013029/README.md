...
## Εισαγωγή
Υλοποίησα συνολικά 7 εργασίες terminal (6 + 1 επιπλέον αντι επαναληπτικής  εξεταστικής) και 3 παραδοτέα συμμετοχικού εκπαιδευτικού υλικού (1 επιπλέον αντί επαναληπτικής  εξεταστικής). Οι ασκήσεις terminal έγιναν σε Ubuntu 20.04 μέσω virtual box. Σε όλα τα παραδοτέα υπάρχει url με την καταγραφή του asciinema (idle time 0.5) που τεκμηριώνει την κάθε άσκηση, καθώς και πηγές απo όπου βρήκα πληροφορίες για την υλοποίηση.

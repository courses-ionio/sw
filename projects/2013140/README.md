...
[![dilwsi-issue.png](https://i.postimg.cc/sDC6dP7j/dilwsi-issue.png)](https://postimg.cc/w3FcDmwZ)
...
[![netlify-account.png](https://i.postimg.cc/FHWw4dhT/netlify-account.png)](https://postimg.cc/
3kGtjw4G)
...
Βλέπουμε τις αλλαγές στο netlify αλλά και στο link που έχει γίνει deploy:

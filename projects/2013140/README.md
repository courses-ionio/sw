...
Κάνουμε add, commit και push, στο repository του p13brif/minimal-ionio.
...
** Το καλύτερο μάθημα που παρακολούθησε ο Αλαν Κεη ως φοιτητής του έδωσε γνώσεις πάνω σε συστήματα που υπήρχαν; **
 ...
 O Bob barton ( ο οποίος είχε φτιάξει ένα hardware που εκτελούσε ένα σύνολο οδηγιών που μοιάζουν με το VM που κωδικοποιείται σε byte) έκανε το καλύτερο μάθημα κατά τον Αλαν Κεη , και ήταν τα advanced systems design ( ο προηγμένος σχεδιασμός συστημάτων ). Αντί να πατήσει πάνω σε ήδη υπάρχοντα συστήματα προτίμησε να ξεκινήσει με τους φοιτητές του από το μηδέν , ώστε να μπορέσουν να εξελιχθούν και να μην αναπαράγουν ιδέες και σχεδιασμούς.

...
Για το 7ο παραδοτέα έπρεπε να μετατρέψουμε το βιογραφικό του παραδοτέου 2, σε μορφή pdf. Για να γίνει αυτό, πρώτα χρησιμοποίησα το εργαλείο pandoc για να έρθει το βιογραφικό σε μορφή .tex, και στη συνέχεια χρησιμοποίησα το texlive-full για να το φέρω σε μορφή pdf.

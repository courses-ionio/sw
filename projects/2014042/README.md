...
Για το 6ο παραδοτέο ασχολήθηκα με την εγκατάσταση του Linux distribution "Kiss Linux". Το Kiss δίνει μεγάλη έμφαση στην απλότητα και στην υπέρμετρη ελευθερία του χρήστη, να τροποποιήσει το σύστημα όπως αυτός επιθυμεί.

...
Ο στόχος ο οποίος έχω θέσει για αυτό το μάθημα, είναι να μπορέσω να δημιουργήσω ένα κλίμα συνεργασίας με τους συμφοιτητές μου, να βοηθήσω σε απορίες για την επίλυση τους και να θέτω τις δικές μου απορίες προς συζήτηση. Επίσης θα ήθελα να εξοικειωθώ στο λογισμικό «linux» διότι δεν έχω δουλέψει σε αυτό ούτε υπάρχει σε κάποιον ηλεκτρονικό υπολογιστή μου,  με αποτέλεσμα να αποκτήσω γνώσεις για το μέλλον. Το μάθημα ευνοεί στην καλύτερη κατανόηση της θεωρίας και της σχεδίασης συστημάτων ανάπτυξης λογισμικού μέσω τεχνολογιών. Τέλος θα μπορέσω να χρησιμοποιήσω για ακόμη μια φορά την πλατφόρμα του github.com που είναι αδιαμφισβήτητα το πλέον απαραίτητο εργαλείο για κάθε προγραμματιστή που σέβεται τον εαυτό του.

Μέχρι στιγμής τα εβδομαδιαία video quiz δεν με δυσκόλεψαν όσο νόμιζα τις πρώτες βδομάδες, όμως με βοήθησαν να καταλάβω το ποσο σημαντικό είναι η καινοτομία η συνεργασία και συζήτηση πάνω σε προβλήματα που προκύπτουν. Έμαθα αρκετούς επιστήμονες του κλάδου που δεν γνώριζα και θα προσπαθήσω να υιοθετήσω τον τρόπο σκέψης τους.
...
# <a name="J">Τελική Αναφορά</a>

Τελειώνοντας το μάθημα, αποκόμισα αρκετές γνώσεις και ικανότητες που δεν είχα. Η φιλοσοφία μου σχετικά με τον τρόπο σκέψης άλλαξε μέσω των βίντεο quiz, έμαθα αρκετούς επιστήμονες του κλάδου και σίγουρα θα υιοθετήσω τον τρόπο με τον οποίο πορεύονται και σκέφτονται πάνω σε νέες τεχνολογίες και στην ανάπτυξη λογισμικού. Επίσης, εξοικειώθηκα με το λογισμικό "linux", είδα πως είναι το UNIX μεσα απο το plan9 που επιτυχώς εγκατέστησα και είδα πως είναι να περνάς ώρες προσπαθώντας να "λύσεις" προβλήματα που προκείπτουν προσπαθώντας να εγκαταστήσω το kiss linux χωρις επιτυχία. Ακόμη μέσα απο το μάθημα γνώρισα άτομα και πέτυχα τον στόχο μου ώστε να γίνω πιο κοινωνικός. Νιώθω σίγουρα πιο εξοικειωμένος με την πλατφόρμα του github και σίγουρα θα χρησιμοποιώ. Ακόμη η δομή του μαθήματος ήταν άκρως ενδιαφέρουσα καθώς τα εβδομαδιαία παραδοτέα βοήθησαν στην διαρκή ενασχόληση με το αντικείμενο του μαθήματος και αισθάνομαι αρκετά ικανοποιημένος καθώς όλες οι υποβολές πραγματοποιήθηκαν στην ώρα τους.  Επίσης ο τρόπος που γινόντουσαν οι συναντήσεις του μαθήματος βοηθάνε αρκετα τον φοιτητή σε προβήματα, που ίσως αυτος ο τρόπος να είναι ένας νέος τρόπος εκμάθησης.

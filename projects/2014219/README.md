...
Για το συγκεκριμένο παραδοτέο δεν έχει γίνει κάποια απο τις προτεινόμενες αλλαγές μέχρι στιγμής. Το μόνο που έχει γίνει απο τα παραπάνω είναι η συγγραφή της Τελικής Αναφοράς σύμφωνα με τις οδηγίες του παραδοτέου.

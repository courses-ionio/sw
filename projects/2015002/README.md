...
Μελλοντικά, στόχος μου είναι να δουλέψω ως Machine Learning Engineer ή Data engineer. Αυτός ο ρόλος απαιτεί να μπορείς να δουλέψεις ως μέλος μίας ομάδας όπου το κάθε άτομο ακολουθεί μεθοδικά οδηγίες για την υλοποίηση και λύση του εκάστοτε προβλήματος. Παράλληλα ως αναλυτής, πέρα από το team work, έχεις να κάνεις και με εξωτερικούς παράγοντες, όπως παρουσιάσεις τον ευρημάτων σου σε άλλα άτομα, συζήτηση με άλλες ομάδες, κλπ.

Για τους πιο πάνω λόγους, ένας από τους βασικούς στόχους που έχω για το μάθημα είναι να matho pos να sinergazome methodika kai apotelesmatika με του συμφοιτητές μου, gia tis lisis  ton diaforon provlimaton pou mpori na emfanistoun kai paralila gia tin prosopiki mou veltiosi stin doulia mou.

Αναμφισβήτητα η πλατφόρμα GitHub είναι ένα εξαιρετικά χρήσιμο και απαραίτητο εργαλείο και με χαροποιεί ιδιαίτερα που θα την ξανά χρησιμοποιήσω για αυτό το μάθημα και για μελλοντικά πρότζεκτ όπως η πτυχιακή μου εργασία! (LINK LATER)

Πέρα από τις δεξιότητες που θα πάρω από το μάθημα στο κομμάτι του Linux, θεωρώ πως το πιο σημαντικό για εμένα είναι το exposure που θα πάρουμε ως μαθητές για το πως είναι να δουλεύει κάποιος μέσα σε μία ομάδα όπου οι πράξεις όλων, επηρεάζουν την ομάδα σαν σύνολο. Στο περασμένο μάθημα δεν υπήρχαν ομάδες, η δουλειά που έβγαζες, επηρέαζε μόνο εσένα, θετικά ή αρνητικά. Τώρα ήμαστε σε μία ομάδα όπου όλοι πρέπει να συμβάλουμε στην υλοποίηση των παραδοτέων. Αυτό απαιτεί συντονισμό, οργάνωση και θέληση. Paralila υπάρχουν οι επιπτώσεις σε σχέση με την δουλειά που βγάζουμε.

Τέλος, προσωπικά για εμένα, ο μεγαλύτερος στόχος που έχω για το μάθημα είναι να μάθω να δουλεύω σε μία ομάδα, να γίνω familiar με τα stages και steps που πρέπει να ακολουθήσουμε σαν ομάδα για την υλοποίηση ενός στόχου/λειτουργίας.
...
Για το 3ο παραδοτέο έπρεπε να βρούμε λάθη στην ιστοσελίδα sitegr και να κάνουμε ένα Αίτημα Ενσωμάτωσης όπου διορθώνουμε αυτά τα λάθη. Η δική μου διόρθωση ήταν ή προσθήκη περιεχομένου για καθηγητή Θεμιστοκλή Έξαρχο.
...
Επίσης έκανα πολλές αλλαγές afou aniksa to Pull Request και gia afto γέμισε με άσχετα commits ta opia έπρεπε να τα κάνω “Squash”, κάτι που δεν ήξερα πως μπορώ να κάνω, είχα χαθεί μέσα στα commits και έγινε ένα χάος με την διαδικασία του Rebase. 

Είμαι σίγουρος πως η διαδικασία ήταν πολύ απλή, η λίγες γνώσεις που είχα στο κομμάτι αυτό ήταν η αιτία που έγιναν όλα πολύπλοκα. Το καλό είναι πως έμαθα πως δουλεύει το Rebase/Revert, έμαθα για τα Pointers των Submodules και έμαθα πως να ανοίγω διάφορα Pull Requests χωρίς Conflicts και άσχετα Commits!
...
INSERT RELEVANT SOURCES FOR PROBLEM
...
Σε αυτό το παραδοτέο είχαμε και την πρώτη πρόκληση σαν ομάδα αλλά και προσωπικά. Αρχικά πάντα δουλεύαμε μόνη μας, δεν υπήρχαν ποτέ conflicts και έκανεs ότι αλλαγή ήθελες χωρίς να πρέπει να το συζητήσεις με κάποιον άλλο. Επίσης συνειδητοποιήσαμε πως η ομάδα δεν είναι λειτουργική έτσι όπως είναι. Είπαμε αρχικά να υπάρχει “αναρχία”. Όλοι είναι ίση. Αυτό το παραδοτέο μας απέδειξε πως δεν είναι εφικτό να λειτουργεί μία ομάδα με τέτοιο τρόπο. Τα πρώτα δύο Pull Request μας έβγαλαν αμέσως Conflicts. Τα κάναμε Revert. Στην συνέχεια έκανα reset το δικό μου Forked Repo και ξανά έκανα την διαδικασία απλά με μία μικρή διαφορά.

Δημιούργησα δύο καινούρια Branches. Το ένα το ονόμασα Netlify όπου εκεί άλλαξα τα αρχεία .gitmodules και config έτσι ώστε να δείχνουν στο προσωπικό μου site. Με αυτό τον τρόπο, τα αρχεία στο Master Branch δεν άλλαξαν. Στην συνέχεια δημιούργησα ακόμη ένα Branch το οποίο ονόμασα A1A2 – 2015002 όπου σε αυτό το branch έκανα tis αλλαγές που αφορούσαν τα παραδοτέα, δεν άλλαξα απολύτως τίποτα άλλο. Episis, Α1Α2 – 2015002 branches άνοιξα και στα ανάλογα submodules, images και _gallery.
...
Για αυτό τον λόγο αποφασίσαμε πως εγώ μαζί με άλλα δύο παιδία, να γίνουμε συντονιστές και είπαμε να γράψουμε μερικούς κανόνες για το πως θα πρέπει να γίνεται η κάθε διαδικασία μέσα στην ομάδα. Μπορείτε να δείτε τα λινκ για τα ανάλογα Discussion στο πεδίο πηγές πιο κάτω.
...
Για το 9ο παραδοτέο εγκατέστησα το ntfy και telegram extension meso pip. Αρχικά η εντολή pip install ntfy[telegram] δεν λειτουργούσε στο σύστημα μου. Το pip δεν το έβρισκε to ntfy kai telegram, episis to pip search den douleve. Gia afto Κατέβασα το pip_search όπου κατάφερα να βρω το πακέτο που χρειαζόμουνα.
...
Pera apo ta notifications sto kinito, vgazi kai notification sto Desktop tou ipologisti.
...
Αποφάσισα να γράψω για το DirectX διότι, θεωρώ πως άλλαξε τον τρόπο παραγωγής multimedia software. Έκανε την διαδικασία πολύ πιο εύκολη για τους Developers και παράλληλα ένταξε τα Windows της Microsoft στον χώρο του Gaming.

Για την βιογραφία θεώρησα καλό να έγραφα για ένα από τους δημιουργούς του DirectX, ο οποίος είχε πολλά προβλήματα και αντιπαραθέσεις κατά την υλοποίηση του DirextX διότι η Microsoft τότε θεωρούσε πως τα Windows δεν θα ήταν ποτέ συστήματα τα οποία θα έτρεχαν Games. Επίσης θα ήθελα να αναφέρω πως το DirectX ήταν η αιτία για την δημιουργία το X-Box.

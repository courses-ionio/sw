...
Σε αυτό το παραδοτέο δυσκολεύτηκα πιο πολύ στο κομμάτι του Pull Request. Υπήρχε ένα μικρό μπέρδεμα για τον τρόπο που έπρεπε να κάνουμε το Pull Request. Αρχικά, έκανα τις αλλαγές και άνοιξα Pull Request στο sitegr. Εν τέλη όμως, οι αλλαγές που έκανα, ανήκαν στο submodule all_collections. Εγώ δεν ήξερα πως έπρεπε να ανοίξω Pull Request στο all_collections και μετά από αρκετό διάβασμα συζητήσεων που είχε ο καθηγητής για το ίδιο πρόβλημα, κατάλαβα τι έπρεπε να κάνω και επίσης κατάλαβα γιατί ήταν λάθος το αρχικό Pull Request όπου φαινότανε απλά το pointer του Submodule αντί οι αλλαγές μου. Επίσης έκανα πολλές αλλαγές και έπρεπε μερικά commits να τα κάνω revert και παράλληλα επειδή έκανα πολλά commits, το Pull Request γέμισε με άσχετα commits και έπρεπε να τα κάνω “Squash” κάτι που δεν ήξερα πως μπορώ να κάνω και είχα χαθεί μέσα στα commits και έγινε ένα χάος με την διαδικασία του Rebase. Είμαι σίγουρος πως η διαδικασία ήταν πολύ απλή, η λίγες γνώσεις που είχα στο κομμάτι αυτό ήταν η αιτία που έγιναν όλα πολύπλοκα. Το καλό είναι πως έμαθα πως δουλεύει το Rebase/Revert, έμαθα για τα Pointers των Submodules και έμαθα πως να ανοίγω διάφορα Pull Requests χωρίς Conflicts και άσχετα Commits!
Επίσης θα ήθελα να σχολιάσω πως μου άρεσε που μπορεί κάποιος να βάλει Closes #3 και αμέσως το GitHub ξέρει για πιο issue / PR μιλάει ο χρήστης και τα κλίνει αυτόματα. Μου φάνηκε πολύ “clean”!

...
- **[bubble_sort.py](https://github.com/ntouloumtzis/sw/blob/2015023/projects/2015023/hyperspy-images/bubble_sort.py)**, **[insertion sort.py](https://github.com/ntouloumtzis/sw/blob/2015023/projects/2015023/hyperspy-images/insertion_sort.py)**, **[selection sort.py](https://github.com/ntouloumtzis/sw/blob/2015023/projects/2015023/hyperspy-images/selection_sort.py)** (Αυτοί είναι οι αλγόριθμοι που πρόκειται να εξεταστούν πάνω στις επιδόσεις τους με το εργαλείο **[hyperfine](https://github.com/sharkdp/hyperfine)**, αλλά και την οπτικοποίηση των δεδομένων που παράγονται απ'αυτά, με το εργαλείο **[py-spy](https://github.com/benfred/py-spy)**)
...
- Εγκατάσταση του εργαλείου `hypefine`
```

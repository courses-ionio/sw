...
***Σημείωση:** Για την παράδοση του παραδοτέου, πριν το αντίστοιχο deadline της εβδομάδας, πραγματοποιήθηκε απλά νέο δικό μου **[αποθετήριο](https://github.com/ntouloumtzis/resume-cv)** μέσω Github και όχι τερματικού, όπως και το deployment του, μέσω **[Github-Pages](https://ntouloumtzis.github.io/resume-cv/)**.*

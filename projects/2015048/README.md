...
Για την τρίτη άσκηση γραμμής εντολών χρησιμοποίησα το Huginn το οποίο χρησιμοποιεί Agents ώστε να ενημερώνει τον χρήστη για νέες δημοσιεύσεις σε όποια σελίδα. Αφού διάβασα ενδελεχώς το Documentation παραμετροποίησα έναν Agent ώστε να με ενημερώνει για την πρόβλεψη του καιρού για την Κέρκυρα. Στην συνέχεια παραμετροποίησα έναν ακόμα Agent έτσι ώστε κάθε φορά που δημοσιεύεται κάτι στην σελίδα news της ιστοσελίδας του Ιονίου Πανεπιστημίου να ενημερώνομαι για την δημοσίευση αυτή.
[Asciinema Link](https://asciinema.org/a/409874)

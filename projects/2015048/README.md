...
| 11 | [Άσκηση γραμμής εντολών 4](#Άσκηση-Γραμμής-Εντολών-4)|
...
Για την τρίτη άσκηση γραμμής εντολών χρησιμοποίησα το Huginn το οποίο χρησιμοποιεί Agents ώστε να ενημερώνει τον χρήστη για νέες δημοσιεύσεις σε όποια σελίδα επιθυμεί ο χρήστης. Αφού διάβασα ενδελεχώς το Documentation παραμετροποίησα έναν Agent ώστε να με ενημερώνει για την πρόβλεψη του καιρού για την Κέρκυρα. Στην συνέχεια παραμετροποίησα έναν ακόμα Agent έτσι ώστε κάθε φορά που δημοσιεύεται κάτι στην σελίδα news της ιστοσελίδας του Ιονίου Πανεπιστημίου να ενημερώνομαι για την δημοσίευση αυτή και τέλος μέσω ενός ακόμα Agent να γίνονται αυτές οι ενημερώσεις post στο καναλι που έχω ήδη δημιουργήσει στο slack.

Πιό αναλυτικά αρχικά έτρεξα την εντολή docker run -it -p 3000:3000 --name ionio-sw-lab-huginn huginn/huginn
Στην συνέχεια μέσω του browser του Host λογισμικού (Ubuntu) εισήλθα στο interface του Huginn στην διεύθυνηση : http://localhost:3000/ χρησιμιποιόντας τα credentials που δώθηκαν απο τον διδάσκοντα στο εργαστήριο.
Ύστερα προσέθεσα έναν Agent τύπου Website Agent παραμετροποίημένο ως εξής:
```
{
 ...
 ```
 Εκτελόντας το με Dry Run έλαβα πίσω τα ακόλουθα:
 ```
[
 {
...
...
```
Τέλος δημιούργησα έναν ακόμα Agent τύπου Post ώστε κάθε φορά που δημιοσιεύεται κάτι καινούριο στα νέα της ιστοσελίδας του πανεπιστημίου να ενημερωνομαι μέσω του slack channel, ο οποίος παραμετροποιήθηκε ως εξής:
...
Φτάνοντας στο τέλος του εξαμήνου μπορώ να πω ότι το συγκεκριμένο μάθημα με βοήθησε να κατανοήσω σε βάθος τις γνώσεις που έλαβα απο το μάθημα "Επικοινωνία Ανθρπωου-Υπολογιστή". Αρχικά το παραδοτέο για το Βιογραφικό σημείωμα με βοήθησε να καταλάβω καλύτερα τις λειτουργίες του Github όσων αφορά την δημιουργία ιστοσελίδων. Στην συνέχεια, τα παραδοτέα για το συμμετοχικό περιεχόμενο με βοήθησαν να προσαρμοστώ σε ένα περιβάλλον συνεργασίας με συμφοιτητές/συναδέλφους από απόσταση και να προσφέρουμε όλοι με τον τρόπο μας σε ένα έργο το οποίο αποτελεί δίαυλο γνώσεων. Τα αιτήματα ενσωμάτωσης, παρ' ότι δεν κατάφερα να ολοκληρώσω το 2ο μέρος, είναι χρήσημα στην κατανόηση της διαδικασίας συμμετοχής σε να έργο (issues, pull requests, reviews κλπ.) όχι μόνο σαν συγγραφέας κάποιων κομματιών του έργου, αλλά και σαν ελενκτής των κομματιών που προσθέτουν άλλοι συναδελφοι. Για τις ασκήσεις γραμμής εντολών ασχολήθηκα κατα κύριο λόγο με εφαρμογές ειδοποιήσεων (mqttwarn, mosquitto, ntfy) οι οποίες είναι πάρα πολύ χρήσιμες, όχι μόνο στον τομέα της πληροφορικής, οι οποίες κατα την αποψή μου θα έπρεπε να χρησιμοποιούνται σε πολλά projects. Τα βίντεο κουίζ με βοήθησαν πολύ να καταλάνω την λογική ανάπτυξης των πιο επιτυχημένων κατα την άποψή μου λογισμικών, ενώ γνώρισα ανθρώπους με των οποίων την άποψη συμφωνώ απόλυτα όπως του Jaron Lanier. Τέλος, κάνοντας έναν πρόχειρο απολογισμο του εξαμήνου, απο το συγκεκριμένο μάθημα αποκόμισα γνώσεις μεγάλης αξίας όχι μόνο πάνω στην τεχνολογία λογισμικού αλλά σε εργαλεία που χρησιμοποιούνται από το μεγαλύτερο ποσοστό επαγγελματιών στην αγορά εργασίας.

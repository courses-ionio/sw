...
...
```
Τέλος δημιούργησα έναν ακόμα Agent τύπου Post ώστε κάθε φορά που δημιοσιεύεται κάτι καινούριο στα νέα της ιστοσελίδας του Πανεπιστημίου να ενημερωνομαι μέσω του slack channel, τον οποίο παραμμετροποίησα ως εξής:

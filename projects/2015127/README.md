...
2. Αυτό που κάνουμε εμείς είναι διαφορετικό από τον συνηθισμένο προγραμματισμό ιστοσελίδας. Δεν χρησιμοποιούμε στυλ και ετικέτες αλλά φτιάχνουμε συνεργατικά την ιστοσελίδα σε ένα κοινό προσυμφωνημένο πλαίσιο.

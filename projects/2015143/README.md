...
| --- | --- | --- |
| 1 |  Eισαγωγή : <sup><a href="#1">Προσωπικοί στόχοι </a></sup> | :chart: |
| 2 | Bιογραφικό : <sup><a href="#2">Iστοσελίδα με χρήση Jekyll </a></sup> | :chart: |
| 3 | Αίτημα ενσωμάτωσης : <sup><a href="#3">Προσθήκη Ανακοίνωσης </a></sup> | :chart: |
| 4 | Άσκηση γραμμής εντολών : <sup><a href="#4">Send notifications to your mobile </a></sup>  | :chart: |
| 5 | Συμμετοχικό περιεχόμενο : <sup><a href="#5">Συμμετοχικό περιεχόμενο Α1 και Α2 </a></sup> | :chart: |
| 6 | Άσκηση γραμμής εντολών | :heavy_multiplication_x: |
| 7 | Bιογραφικό : <sup><a href="#7">Δημιουργία pdf του βιογραφικού </a></sup> | :heavy_multiplication_x: |
| 8 |  Αίτημα ενσωμάτωσης : <sup><a href="#8">Προσθήκη Νέου Topic </a></sup> | :chart: |
| 9 | Άσκηση γραμμής εντολών | :heavy_multiplication_x: |
| 10 | Συμμετοχικό περιεχόμενο : <sup><a href="#10">Συμμετοχικό περιεχόμενο Β1 και Β2 </a></sup> | :heavy_multiplication_x: |
| 11 | Άσκηση γραμμής εντολών | :heavy_multiplication_x: |
| 12 | Συμπεράσματα : <sup><a href="#12">Σύγκριση στόχων-αποτελεσμάτων </a></sup> </a></sup> | :chart: |
| - | Video Quiz : <sup><a href="#13"> Απαντήσεις </a></sup> | :chart: |

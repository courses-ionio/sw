...
Γενικότερα, όλα τα διαγράμματα υλοποιήθηκαν εκ' νέου και για τον σκοπό αυτόν μελετήθηκαν και δοκιμάστηκαν πολλά παραδείγματα ραφημμάτων πίτας που βρήκα online. Όλος ο κώδικας είναι διαθέσιμος στο αρχείο pie.js, αξίζει όμως να σχολιαστεί ο τρόπος με τον οποίο κατασκευάστηκαν οι διαφορετικές επιλογές ομαδοποίησης.

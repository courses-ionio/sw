...
Στο συγκεκριμένο παραδοτέο που αφορά την εγκατάσταση και χρήση γραμμή εντολών Linux σε σύστημα που δεν περιλαμβάνει systemd επέλεξα να ασχοληθώ με τα λειτουργικά 9legacy (plan9) και funtoo. Screenshots για τις εγκαταστάσεις και από την χρήση που έγινε στα δύο συστήματα βρίσκονται στο παρακάτω σύνδεσμο.
...
Το Unix δεν είναι το Σχέδιο 9. Αν θεωρείτε ότι είναι σαν το Unix, μπορεί να αναστατωθείτε όταν κάτι δεν υπάρχει ή συμπεριφέρεται διαφορετικά από ό,τι περιμένατε. Ωστόσο, αν το σκεφτείτε ως Σχέδιο 9, θα ανακαλύψετε ότι η πλειοψηφία του λειτουργεί αρκετά καλά και ότι υπάρχουν μερικές πραγματικά έξυπνες ιδέες που κάνουν τα πράγματα πολύ πιο καθαρά από ό,τι έχετε δει ποτέ.

...
Στο μάθημα αυτο έμαθα να χρησιμοποιώ ακόμη καλύτερα το command line μέσω των ασκήσεων και έμαθα διάφορα χρήσιμα εργαλεία ( spark , ntfy , hugo , py-spy ) και διάφορες άλλες εντολές που δεν ήξερα. Επίσης εμαθα να χειρίζομαι το github που είναι αρκετά σημαντικό κομμάτι του μαθήματος και γενικά στον τομέα της πληροφορικής. Τέλος μέσω των video quiz άκουσα απόψεις απο πολλούς ειδικούς στην πληροφορική που έχουν καταφέρει πολύ σημαντικά επιτεύγματα στον τομέα μας. 

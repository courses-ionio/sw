...
Σύμφωνα με τον Αλαν Κεη η μεγαλύτερη παγίδα για τους φοιτητές ειναι να πέρνουν την τεχνολογία που εχουμε ως τώρα ως δεδομένη και να βασιζόμαστε πανω σε αυτή δηλαδή το να μην την αμφισβητούμε.Η αντίστοιχη IBM στις μέρες μας είναι η Microsoft με τα Windows κατα την γνώμη μου.

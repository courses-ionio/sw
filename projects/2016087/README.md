...
| --- | --- | :-: | --- | :-: |
| 1η | [Eισαγωγή](#1ο-παραδοτέο---εισαγωγή) | [Link Παραδοτέου (Discussions)](https://github.com/courses-ionio/help/discussions/800) | Το συγκεκριμένο παραδοτέο πιστεύω είναι πλήρες ως προς την εκτέλεση του οπότε θα έβαζα στον εαυτό μου ένα 9/10 εφόσον μπορεί να μου έχει ξεφύγει κάποια σημαντική λεπτομέρεια. | Πλήρης Εκτέλεση |
| 2η | [Βιογραφικό](#2o-παραδοτέο---βιογραφικό) | [Link Παραδοτέου (Discussions)](https://github.com/courses-ionio/help/discussions/801) | Το συγκεκριμένο παραδοτέο πιστεύω είναι πλήρες ως προς την εκτέλεση του οπότε θα έβαζα στον εαυτό μου ένα 9/10 εφόσον μπορεί να μου έχει ξεφύγει κάποια σημαντική λεπτομέρεια. | Πλήρης Εκτέλεση |
| 3η | [Κατασκευή του βιβλίου Α](#3o-παραδοτέο---κατασκευή-του-βιβλίου-α) | [Link Παραδοτέου (Discussions)](https://github.com/courses-ionio/help/discussions/2129) | Το συγκεκριμένο παραδοτέο πιστεύω είναι πλήρες ως προς την εκτέλεση του οπότε θα έβαζα στον εαυτό μου ένα 9/10 εφόσον μπορεί να μου έχει ξεφύγει κάποια σημαντική λεπτομέρεια. | Πλήρης Εκτέλεση |
...
| 6η | [Βιογραφικό](#6o-παραδοτέο---bιογραφικό) | [Link Παραδοτέου (Discussions)](https://github.com/courses-ionio/help/discussions/805) | Το συγκεκριμένο παραδοτέο πιστεύω είναι πλήρες ως προς την εκτέλεση του οπότε θα έβαζα στον εαυτό μου ένα 9/10 εφόσον μπορεί να μου έχει ξεφύγει κάποια σημαντική λεπτομέρεια. | Πλήρης Εκτέλεση |
| 7η | [Άσκηση γραμμής εντολών](#7o-παραδοτέο---άσκηση-γραμμής-εντολών) | [Link Παραδοτέου (Discussions)](https://github.com/courses-ionio/help/discussions/806) | Το συγκεκριμένο παραδοτέο πιστεύω είναι πλήρες ως προς την εκτέλεση του οπότε θα έβαζα στον εαυτό μου ένα 9/10 εφόσον μπορεί να μου έχει ξεφύγει κάποια σημαντική λεπτομέρεια. | Πλήρης Εκτέλεση |
| 8η | [Κατασκευή του βιβλίου Β](#8o-παραδοτέο---κατασκευή-του-βιβλίου-β) | [Link Παραδοτέου (Discussions)](https://github.com/courses-ionio/help/discussions/2131) | Το συγκεκριμένο παραδοτέο πιστεύω είναι πλήρες ως προς την εκτέλεση του οπότε θα έβαζα στον εαυτό μου ένα 9/10 εφόσον μπορεί να μου έχει ξεφύγει κάποια σημαντική λεπτομέρεια.  | Πλήρης Εκτέλεση |
...
| 10η | [Τελική αναφορά](#10ο-παραδοτέο---τελική-αναφορά--συμπεράσματα) | [Link Παραδοτέου (Discussions)](https://github.com/courses-ionio/help/discussions/2133) | Το συγκεκριμένο παραδοτέο πιστεύω είναι πλήρες ως προς την εκτέλεση του οπότε θα έβαζα στον εαυτό μου ένα 9/10 εφόσον μπορεί να μου έχει ξεφύγει κάποια σημαντική λεπτομέρεια.  | Πλήρης Εκτέλεση |

...
Για τη δημιουργία του βιογραφικού χρησιμοποιήθηκε το συγκεριμένο [template](https://github.com/sharu725/online-cv) από αυτά που υπήρχαν στις οδηγίες και στη συνέχεια έγιναν οι απαραίτητες αλλαγές έτσι ώστε να μπορέσω να το προσαρμόσω στα δικά μου στοιχεία.</p>

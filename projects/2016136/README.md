...
# Βιογραφικό
  - Command line Bio
   ...
   Λαμβάνοντας υπόψιν τις οδηγίες στο sw-lab καθώς και ότι έχουμε αναφέρει στις θεωρητικές διαλέξεις έφτιαξα το conteiner μου, έκανα σύνδεση με το github, έφτιαξα τα directories εγκατέστησα τα ruby, jekyll,  Στην συνέχεια έφτιαξα τα directories και έκανα την σύνδεση με το github με τις κατάλληλες εντολές, μετα έφτιαξα τα Gems files μου και τα αρχεία μου yml και html σύμφωνα με τις οδήγιες του ionio-sw-pab για να ξεκινήσω να βαζω τις πληροφορίες στο βιογραφικό 

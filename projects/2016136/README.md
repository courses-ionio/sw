...
# Βιογραφικό
  - Command line Bio
   ...
   Λαμβάνοντας υπόψιν τις οδηγίες στο sw-lab καθώς και ότι έχουμε αναφέρει στις θεωρητικές διαλέξεις εγκατέστησα στον τερματικό του VM τα ruby, jekyll, docker και όλα τα προ απαιτούμενα. Στην συνέχεια έφτιαξα τα directories μου και αφού δημιούργησα το αποθετήριο μου και έκανα την σύνδεση με το github με τις κατάλληλες εντολές, έφτιαξα τα αρχεία μου yml και html για να ξεκινήσω να θέτω την βάση μου με τις πληροφορίες μου για το βιογραφικό 

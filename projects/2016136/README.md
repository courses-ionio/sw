...
Πρόσθεσα ένα jekyll θέμα στο cv που το είχα χωρίς. Πρόσθεσα όλους τους φακέλους και κάποια directions με φακέλους όπως ακριβώς αναφέρεται και στο θέμα που επέλεξα να πάρω και αποτέλεσε έναν πολύ καλό [οδηγό](https://github.com/sproogen/modern-resume-theme) και στο τέλος επεξεργάστηκα αυτά τα αρχεία με τα προσωπικά μου στοιχεία.Για να κάνω αυτές τις προσθήκες βοήθησαν πολύ οι γνώσεις που ήδη έχω από την πρώτη απόπειρα δημιουργίας βιογραφικού αλλά και από την άσκηση γραμμής εντολών 2. 

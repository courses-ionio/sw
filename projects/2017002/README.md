...
| 10 | Τελική αναφορά* | https://github.com/courses-ionio/sw/discussions/1648| Έγραψα την τελική μου αναφορά  |
...
Αφού ολοκλήρωσα την υλοποίηση των παραδοτέων του μαθήματος κατάφερα να αποκομίσω γνώσεις και εμπειρία για την διαχείριση άγνωστων για εμένα εργασιών. Αν και η πρώτη μου επαφή με τα ubuntu , το github και τις εντολές στον terminal ήρθαν με το μάθημα Επικοινωνια ανθρώπου - υπολογιστή, τα παραδοτέα που ασχολήθηκα σε αυτό το μάθημα με βοήθησαν να εξοικιωθώ περισσότερο με αυτές τις λειτουργίες και κάποιες απο αυτές να τις εντάξω και στην καθημερονότητα μου (π.χ. πλέον χρησιμοποιώ μόνιμα τα ubuntu στον υπολογιστή μου και κάνω όλες τις διεργασίες μέσω του τερματικού). Πιο συγκεκριμένα, έμαθα να κάνω install και να χρησιμοποιώ τα ubuntu και τα artix linux. Στην συνέχεια μέσω της χρήσης του pollen έμαθα να επεξεργάζομαι βιβλία και αλλάζω την μορφή τους. Στην συνέχεια ,με την βοήθεια του hugo έμαθα τον τρόπο για να δημιουργώ νέα blog και να τα διαμορφώνω όπως εγω θέλω. Τέλος, έμαθα να κάνω deploy ένα site μέσω του netlify,πράγμα το οποίο με δυσκόλεψε περισσότερο από κάθε άλλο παραδοτέο. Πιστέυω πως έχω καταβάλει μια αξιοπρεπή προσπάθεια και είμαι ικανοποιημένος με την επίδοση μου.

## Link σχολιασμών σε pull request συμφοιτητών
[link 1](https://github.com/courses-ionio/sw/pull/1737)

[link 2](https://github.com/courses-ionio/sw/pull/1715)

## Βίντεο Quiz
p17mand@ionio  2017002

## Σχόλια βελτίωσης απο τον συνδισάσκοντα
Κατά την παρουσίαση στον συνδιδάσκοντα, ο κ. Α. Βραχάτης σχολίασε πως όλα τα παραδοτέα είναι σε αξιοπρεπή κατάσταση με εξαίρεση το παραδοτέο της εβδοδμάδας 4 το οποίο δεν κατάφερα να υλοποιήσω με επιτυχία και μου πρότεινε να το προσπαθήσω ξανά. Η παρουσίαση πραγματοποιήθηκε Τετάρτη 26 Απριλίου.

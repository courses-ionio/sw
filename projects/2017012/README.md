...
* [Διαδραστικό παράδειγμα στο βιβλίο](https://thodoros.netlify.app/remix/terminal/)
 ...
 ### Επιπλέον διαδραστικό παράδειγμα
...
# Συμπεράσματα
  Το command line αποτελεί ένα μέρος του λογισμικού το οποίο προσφέρει απεριόριστες δυνατότητες στο χρήστη για την παραμετροποίηση του συστήματος, διαχείριση και χειρισμό αρχείων καθώς και την υλοποιήση διεργασιών, από τις καθημερινές και πιο απλές μέχρι και τις πιο σύνθετες και δύσκολες. Παρόλο που στην αρχή μπορεί να φαίνεται σαν ένα δύστροπο και δυσνόητο κομμάτι να κατανοήσει κάποιος, στην πραγματικότητα δεν είναι κάτι ιδιαίτερα δύσκολο μετά την στοιχειώδη ενασχόληση με αυτό. Μέσα από τις εργασίες που μας παρουσιάστηκαν ήρθα σε μία πρώτη επαφή με αυτό το κομμάτι του υπολογιστή και έμαθα να το χρησιμοποιώ σε ένα αξιόλογο επίπεδο, με βάση το γεγονός ότι δεν είχα προηγούμενες γνώσεις πάνω στο κομμάτι αυτό. Παράλληλα, με την αναζήτηση παραδειγμάτων για το συμμετοχικό υλικό ήρθα σε επαφή με λογισμικό και υλοποιήσεις που δεν γνώριζα ότι υπήρχαν.   

...
Για την 5η εβδομάδα του μαθήματος, όπως φαίνεται και στον παραπάνω πίνακα, είχαμε να αναλάβουμε το Συμματοχικό Περιεχόμενο. Ακολουθώντας τις οδηγίες του μαθήματος, δημιούργησα ένα αντίγραφο (fork) <a href="https://github.com/pibook/site">της ιστοσελίδας του βιβλίου του μαθήματος</a> και πρόσθεσα μόνο <a href="https://github.com/p17kour/gr">στο δικό μου αντίγραφο</a> δύο νέες εικόνες με λεζάντα και με ελεύθερα πνευματικά δικαιώματα ή που επιτρέπουν εμπορική χρήση. Επειδή την συγκεκριμένη άσκηση την είχα πραγματοποιήσει στο μάθημα «Επικοινωνία Ανθρώπου Υπολογιστή», υπάρχει ήδη στο αντίγραφό μου ένα κλαδί (branch) με τίτλο τον Αριθμό Μητρώου μου, στο οποίο είχα αλλάξει, τότε, δύο φωτογραφίες μαζί με τις νέες λεζάντες τους. Σήμερα στο μάθημα «Τεχνολογία Λογισμικού», θα επιχειρήσω να αλλάξω ή προσθέσω φωτογραφίες στο φάκελο `_gallery`, οι οποίες δεν θα είναι ίδιες με τις τότε φωτογραφίες που είχα στο άλλο μάθημα. 

Αρχικά, πήρα την απόφαση να δοκιμάσω να προσθέσω <a href="https://github.com/pibook/site">στην ιστοσελίδα του βιβλίου του μαθήματος</a> έναν νέο αρχείο `.md`. Στον φάκελο, λοιπόν, `_gallery` πρόσθεσα ένα καινούριο αρχείο με όνομα `arduino_mega.md`, μιας και παρατήρησα ότι υπήρχαν ήδη 4 αρχεία που είχαν σχέση με το Αrduino. Το καινούριο αρχείο υπάρχει <a hef="https://github.com/p17kour/gr/blob/2017019/_gallery/arduino_mega.md">εδώ</a>. Στην συνέχεια, προχώρησα στην προσθήκη των δύο εικόνων στο φάκελο `images`. Η μια φωτογραφία είναι η κανονική με τίτλο arduino_mega.png και η δεύτερη είναι η ίδια φωτογραφία αλλά μικρή (με διαστάσεις 160x160 pixels), η οποία έχει όνομα arduino_mega-thumb.jpg. Τις φωτογραφίες μπορούμε να τις βρούμε <a href="https://github.com/p17kour/gr/blob/2017019/images/arduino_mega-thumb.jpg">εδώ για την μικρή</a> και <a href="https://github.com/p17kour/gr/blob/2017019/images/arduino_mega.png">εδώ για την κανονική</a>.

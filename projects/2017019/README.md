...
Για την 3η Εβδομάδα, το βίντεο με τίτλο Alan Kay Computing Simply, οι απαντήσεις των ερωτήσεων μου είναι:
1). Ποιες ήταν οι βασικές ιδέες που επηρέασαν τον Αλαν Κεη στην κατασκευή νέου λογισμικού;
    Οι βασικές ιδέες που τον επηρέασαν είχαν να κάνουν με τη δημιουργία και διανομή εκπαιδευτικών συσκευών για τον αναπτυσσόμενο κόσμο και με τη δημιουργία λογισμικού
    και περιεχομένου για αυτές τις συσκευές. Ο στόχος του ήταν να μεταμορφωθεί η εκπαίδευση, επιτρέποντας στα παιδιά σε χώρες χαμηλού εισοδήματος να έχουν πρόσβαση σε               περιβάλλοντα περιεχομένου, μέσων και προγραμματισμού υπολογιστών.
    
3). Να δώσετε παράδειγμα από την προσωπική σας εμπειρία για λογισμικό με καλή και με κακή αρχιτεκτονική με αναφορά στα κριτήρια της επιλογής σας.
    
5). Ποια είναι τα βασικά δομικά στοιχεία στην αρχιτεκτονική του λογισμικού etoys και από που άντλησε ο Αλαν Κέη την έμπνευση για αυτά;
6). Ποια είναι κάποια από τα λάθη των σύγχρονων λειτουργικών συστημάτων σύμφωνα με τον Αλαν Κέη;

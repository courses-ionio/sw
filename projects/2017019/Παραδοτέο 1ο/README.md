...
κατασκευή λογισμικού, να έχω την ικανότητα να σχεδιάζω και να κατασκευάζω λογισμικού και, φυσικά, να μπορώ να διορθώνω και να εξελίσσω το λογισμικό για την καλύτερη λειτουργία του 
και για να μάθω καλύτερα αυτό το αντικείμενο.
...
έπειτα δημιούργησα ένα branch με τίτλο τον αριθμό μητρώου μου (2017019) και μέσα σε αυτό πρόσθεσα ένα αρχείο με τίτλο πάλι τον αριθμό μητρώου μου, στο οποίο θα προσθέτω αρχεία με 
τίτλο τα παραδοτέα που έχω φτιάξει, καθώς και θα γίνονται αναφορές σε τυχόν αλλαγές που διέπραξα για την καλύτερη λειτουργία των εργασιών.

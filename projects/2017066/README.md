...
* Για την διεκπαιρέωση των εργασιών του συμμετοχικού υλικού, αποφάσισα να κάνω 2 παραδοτέα, το Α και το Β. Για το Α παραδοτέο πρόσθεσα  δύο νέες εικόνες με λεζάντα. Η πρώτη είναι το Kinect και η δεύτερη το Google Maps. Για το Β παραδοτέο πρόσθεσα ένα διαδραστικό παράδειγμα που απεικονίζει την αξιολόγηση με αστέρια που χρησιμοποιείται παντού στον ιστό. Προφανώς ο επισκέπτης-χρήστης της σελίδας μπορεί να επεξεργαστεί το διαδραστικό παράδειγμα αφού είναι στο Codepen.

* [link kinect](https://dmisa.github.io/gr/gallery/kinect/)
* [link g-maps](https://dmisa.github.io/gr/gallery/google-maps/)
* [link διαδραστικού παραδείγματος](https://dmisa.github.io/gr/remix/star_rating/)

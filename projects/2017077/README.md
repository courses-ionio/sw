...
<br>
  ![screenshots στο κινητό μου με τον bot father καθώς και ειδοποιήσεις που στέλνονταν στο bot μου μετά την ολοκλήρωση εντολών στο terminal ](Images/mobilentfy.png)

 ...
 **SourceForge**
 ...
 Σε ότι έχει να κάνει με το **Β** παραδοτέο βρήκα ένα διαδραστικό παράδειγμα απο την σελίδα του [codepen](https://codepen.io/) το οποίο παρέχει στον χρήστη ένα terminal σε γλώσσα προγραμματισμού html5(και css,javascript) το οποίο δίνει την δυνατότητα να δώσεις κάποιες εντολές έχοντας με αυτόν τον τρόπο μία μικρή ιδέα για το πώς είναι να εργάζεσαι με ένα τερματικό. Παρακάτω δίνονται τα link του διαδραστικού παραδείγματος που οδηγούν στο αποθετήριο μου καθώς αντίστοιχα και μέσα στην ιστοσελίδα του βιβλίου:
 
 **HTML5 Web Terminal**
  * https://github.com/chriskalo/gr/blob/master/_remix/web-terminal.md
  * https://chriskalo.netlify.com/remix/web-terminal/
 
 Μετά την αλλαγή στον τρόπο εξέτασης του μαθήματος(επιπλέον άσκηση και συμμετοχικό υλικό), επέλεξα να ασχοληθώ με την εύρεση ενός ακόμα διαδραστικού παραδείγματος(**Β** παραδοτέο). Για την εύρεση παραδείγματος, χρησιμοποίησα την σελίδα του [codepen](https://codepen.io/) μέσω της οποίας βρήκα ένα web app το οποίο κάνει χρήση της API του github δίνοντας την δυνατότητα στον χρήστη να αναζητήσει οποιονδήποτε github user βλέποντας δεδομένα του όπως αριθμό followers, repositories κλπ. Παρακάτω, δίνονται τα link του διαδραστικού παραδείγματος που οδηγούν στο αποθετήριο μου καθώς αντίστοιχα και μέσα στην ιστοσελίδα του βιβλίου:

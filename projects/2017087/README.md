...
| 2 | [2ο Παραδοτέο - Βιογραφικό](#2ο Παραδοτέο - Βιογραφικό)| |Για το 2ο παραδοτέο δημιούργησα το βιογραφικό μου δυστυχώς στην συνέχεια δεν μπόρεσα να ενταχθώ σε κάποια ομάδα. |
| 3 | [3ο Παραδοτέο - Αίτημα ενσωμάτωσης στην ιστοσελίδα](#3ο Παραδοτέο - Αίτημα ενσωμάτωσης στην ιστοσελίδα) | |Για το 3ο παραδοτέο έκανα προσθήκη μιας ανακοίνωσης αφού πήρα green light .|
| 4 | [ 4ο Παραδοτέο - Εγκατάσταση λογισμικού (άσκηση γραμμής εντολών)](# 4ο Παραδοτέο - Εγκατάσταση λογισμικού (άσκηση γραμμής εντολών)) | |Για το 4ο παραδοτέο έκανα εγκατάσταση του freebsd . |
| 5 | [Συμμετοχικό περιεχόμενο 1 ]| |Ήταν το παραδοτέο που με δεν κατάφερα να υλοποιήσω |
| 6 | [6ο Παραδοτέο - 'Ασκηση γραμμής εντολών](#6ο Παραδοτέο - 'Ασκηση γραμμής εντολών) | |Εγκατάσταση του Wttr.in , η συγκεκριμένη εντολή μου φάνηκε πολύ χρήσιμη.|
| 7 | [7ο Παραδοτέο - Βιογραφικό PDF](#7ο Παραδοτέο - Βιογραφικό PDF) | |  Εγκατάσταση των απαραίτητων εντο΄λων και μετατροπή σε pdf δεν κατάφερα να κανώ τα github hooks να λειτουργήσουν.|
| 8 | [Αίτημα ενσωμάτωσης στην ιστοσελίδα 2](#Αίτημα) | |
| 9 | [# 9ο Παραδοτέο - 'Ασκηση γραμμής εντολών](# 9ο Παραδοτέο - 'Ασκηση γραμμής εντολών) | |Εγκατάσταση ntfy. |
| 10 | [Συμμετοχικό περιεχόμενο 2]() | | Δεν υλοποίήθηκε  |
| 11 | [ 11ο Παραδοτέο - 'Ασκηση γραμμής εντολών](# 11ο Παραδοτέο - 'Ασκηση γραμμής εντολών) | |Spreadsheet calculator|
| 12 | [12ο Παραδοτέο - Τελική αναφορά](#12ο Παραδοτέο - Τελική αναφορά) | |Εν κατακλείδι δεν ξέρω πως να αξιολογηθώ σίγουρα έμαθα χρήσιμα πράγματα αλλά είχα και δυσκολίες ώστε να αξιοποιήσω αρκετά . Θα κρατήσω μόνο τα καλά τα οποία πήρα από το μάθημα . |

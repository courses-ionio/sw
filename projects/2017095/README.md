...
| 8 | [Αίτημα ενσωμάτωσης στην ιστοσελίδα](#8-αίτημα-ενσωμάτωσης-στην-ιστοσελίδα-2) | https://github.com/courses-ionio/help/discussions/722 | |
| 9 | Άσκηση γραμμής εντολών | | Δεν ολοκληρώθηκε |
| 10 | συμμετοχικό περιεχόμενο B1+B2 | | Δεν ολοκληρώθηκε |
| 11 | Άσκηση γραμμής εντολών | | Δεν ολοκληρώθηκε |
| 12 | [Τελική αναφορά](#12-τελική-αναφορά) | https://github.com/courses-ionio/help/discussions/723 | |
...
Για την οργάνωση της ομάδας, έκανα fork τα αποθετήρια που σχετίζονται με το site, και αποφασίσαμε να κάνουμε τις αλλαγές στο βασικό αποθετήριο μέσω Pull Request, όπου δύο μέλη με write access (που έχουν όλοι) θα πρέπει να ελέγξουν και να δεχτούν τις αλλαγές που έχουν να κάνουν με τις οδηγίες που έγραψα και τη σύνδεση με το Netlify. Επίσης, πρόσθεσα ένα github workflow το οποίο, αν ένα Pull Request δεν έχει κάποια ανανέωση για 7 μέρες, του ορίζει το label "stale", και αναλαμβάνω εγώ, ως συντονιστής, να το δεχτώ ή να το κλείσω.
...
Για το δεύτερο αίτημα ενσωμάτωσης στην ιστοσελίδα, ανανέωσα τις οδηγίες Workflow στο Wiki, καθώς είχαν γίνει αλλαγές στο στήσιμο της ιστοσελίδας και οι οδηγίες δεν είχαν ανανεωθεί. Αρχικά ανέβασα τις οδηγίες στις συζητήσεις, ώστε να μου πουν και οι συμφοιτητές αν έχω παραλείψει ή αν έχω κάνει κάποιο λάθος, κι έπειτα τις ανέβασα στο wiki του sitegr. Δεν βρήκα τρόπο να κάνω Pull Request ώστε να φανούν, οπότε απλά τις ανέβασα.

[Issue](https://github.com/ioniodi/sitegr/issues/384)

[Συζητήσεις](https://github.com/courses-ionio/help/discussions/544)

...
Το διαδραστικό παράδειγμα αυτό απεικονίζει μία επιφάνεια εργασίας ενός Λειτουργικού συστήματος Mac. Δίνοντας έτσι στον χρήστη
την ευκαιρία να αλληλεπιδράσει με την επιφάνεια εργασίας αυτή.

## Πρόσθετες Εργασίες αντί για Τελική εξέταση

Εργασία συμμετοχικού περιεχομένου: https://sotiris132.github.io/gr/remix/How%20To%20Terminal/

Αυτό το διαδραστικό παράδειγμα δείχνει στον χρήστη πως είναι ένα Τερματικό (Command Line) και του δείχνει μερικέσ βασικές εντολές ενός τερματικού, όπως το: ls,cd,pwd,touch,move,cat...κλπ.

...
#### 5) Βρήκαμε πως θα στείλουμε ειδοποίηση στο κινητό, βρήκαμε τι θα βάλουμε στον υπολογιστή να τρέξει, ήρθε η ώρα να δούμε αμα θα λειτουργεί η ιδέα, και έτρεξα την εξής εντολή:

...
Ωστόσο, εχω μεγάλο δρόμο μπροστά μου καθώς αντιμετοπίζω προβλήματα με τα τερματικά, τα οποία και δουλεύω εν καιρό και ελπίζω να καταφέρω να τα λύσω και να ολοκληρώσω με επιτυχία και αυτό το κομματι της εργασίας, που αποτελεί για εμένα το πιο δύσκολο.

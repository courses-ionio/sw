...
# Παραδοτέο 12
Κλείνοντας, σε αυτό το μάθημα μπήκα με πολύ λίγη εμπειρία πάνω στα αντικείμενα που μας απασχόλησαν. Στόχος μου ήταν κυρίως η εκμάθηση των εργαλείων, κάτι που νιώθω πως πέτυχα. Ομολογουμένως ήταν μια μεγάλη πρόκληση δεδομένου ότι δεν είχα σχεδον καθόλου εμπειρία με πολλά κομμάτι του μαθήματος, επομένως θεωρώ πως κατάφερα να βελτιωθώ σε πολλά κομμάτια.
Χάρη στο μάθημα αυτό απέκτησα μια λίγο καλύτερη εικόνα σχετικά με τον χειρισμο του github (παρότι ακόμα δεν την γνωρίζω τόσο καλά όσο θα ήθελα), μια βελτιωμένη άνεση στον χειρισμό τερματικού και μια εισαγωγική εικόνα στον κόσμο του linux.

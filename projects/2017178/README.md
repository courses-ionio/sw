...
| 8 | Αίτημα ενσωμάτωσης στην ιστοσελίδα | [link](https://github.com/courses-ionio/help/discussions/689) | Δεν πέτυχα τον στόχο μου, ωστόσο μελέτησα τα actions του github και νιώθω πως θα μπορούσαν να μου φανούν χρήσιμα. |
...
| 12 | Τελική αναφορά* | [link](https://github.com/courses-ionio/help/discussions/690)| | 
...
# Παραδοτέο 8: Αίτημα ενσωμάτωσης στη σελίδα
...
# Παραδοτέο 12
Κλείνοντας, σε αυτό το μάθημα μπήκα με πολύ λίγη εμπειρία πάνω στα αντικείμενα που μας απασχόλησαν. Στόχος μου ήταν κυρίως η εκμάθηση των εργαλείων και όχι η τέλεια εκτέλεση των παραδοτέων, κάτι που νιώθω πως πέτυχα. Ομολογουμένως ήταν μια μεγάλη πρόκληση δεδομένου ότι δεν είχα εμπειρία με κανένα κομμάτι του μαθήματος, επομένως θεωρώ πως κατάφερα να βελτιωθώ σε πολλά κομμάτια.
Χάρη στο μάθημα αυτό απέκτησα μια λίγο καλύτερη εικόνα σχετικά με τον χειρισμ. του github (παρότι ακόμα δεν την γνωρίζω τόσο καλά όσο θα ήθελα), μια βελτιωμένη άνεση στον χειρισμό τερματικού και μια εισαγωγική εικόνα στον κόσμο του linux.
Το pull request μου μπορείτε να το βρείτε [εδώ](https://github.com/courses-ionio/sw/pull/11030)

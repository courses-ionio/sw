...
| 3 | [Αίτημα ενσωμάτωσης στην ιστοσελίδα](#) <sup><a href="#απαντήσεις-βίντεο-quiz-εβδομάδα-3η"> βίντεο quiz</a></sup>|
...
**Question:** "Ποιες ήταν οι βασικές ιδέες που επηρέασαν τον Αλαν Κεη στην κατασκευή νέου λογισμικού;"<br>**Answer:** 


**Question:** "Να δώσετε παράδειγμα από την προσωπική σας εμπειρία για λογισμικό με καλή και με κακή αρχιτεκτονική με αναφορά στα κριτήρια της επιλογής σας."<br>**Answer:** 


**Question:** "Ποια είναι τα βασικά δομικά στοιχεία στην αρχιτεκτονική του λογισμικού etoys και από που άντλησε ο Αλαν Κέη την έμπνευση για αυτά;"<br>**Answer:** 



**Question:** "Ποια είναι κάποια από τα λάθη των σύγχρονων λειτουργικών συστημάτων σύμφωνα με τον Αλαν Κέη;"<br>**Answer:** 

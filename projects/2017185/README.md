...
| 12 | [Τελική αναφορά](#τελική-αναφορά) | [12ο](#απαντήσεις-βίντεο-quiz-εβδομάδα-12η) |
...
# 2ο αίτημα ενσωμάτωσης στην ιστοσελίδα
   ...
   - Και ένα [δεύτερο](https://github.com/ioniodi/sitegr/pull/218) στο sitegr
   - Έγιναν αποδεκτά και merge!
...
# Τελική Αναφορά
  Επιτέλους, τελείωσε και αυτό το μάθημα. Τουλάχιστον πήρα αρκετές γνώσεις. Μου άρεσε αρκετά το ότι έφτιαξα ένα βιογραφικό. Σίγουρα το μάθημα αυτό δεν έχει λίγα παραδοτέα αλλά τουλάχιστον δεν χρειάζεται να δώσουμε εξετάσεις!

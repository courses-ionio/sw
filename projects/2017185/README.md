...
| --- | --- | --- |
| 1 | [Εισαγωγή](#εισαγωγή) | [1ο](href="#απαντήσεις-βίντεο-quiz-εβδομάδα-1η") |
| 2 | [Βιογραφικό](#βιογραφικό) | [2ο](href="#απαντήσεις-βίντεο-quiz-εβδομάδα-2η") |
| 3 | [Αίτημα ενσωμάτωσης στην ιστοσελίδα](#1ο-αίτημα-ενσωμάτωσης-στην-ιστοσελίδα) | [3ο](href="#απαντήσεις-βίντεο-quiz-εβδομάδα-3η") |
| 4 | [Άσκηση γραμμής εντολών](#1η-άσκηση-γραμμής-εντολών) | [4ο](href="#απαντήσεις-βίντεο-quiz-εβδομάδα-4η") |
| 5 | [Συμμετοχικό περιεχόμενο](#συμμετοχικό-περιεχόμενο-1ο) | [5ο](href="#απαντήσεις-βίντεο-quiz-εβδομάδα-5η") |
| 6 | [Άσκηση γραμμής εντολών](#2η-άσκηση-γραμμής-εντολών) | [6ο](href="#απαντήσεις-βίντεο-quiz-εβδομάδα-6η") |
| 7 | [Βιογραφικό](#βιογραφικό-pdf) | [7ο](href="#απαντήσεις-βίντεο-quiz-εβδομάδα-7η") |
| 8 | [Αίτημα ενσωμάτωσης στην ιστοσελίδα](#2ο-αίτημα-ενσωμάτωσης-στην-ιστοσελίδα) | [8ο](href="#απαντήσεις-βίντεο-quiz-εβδομάδα-8η") |
| 9 | [Άσκηση γραμμής εντολών](#3η-άσκηση-γραμμής-εντολών) | [9ο](href="#απαντήσεις-βίντεο-quiz-εβδομάδα-9η") |
| 10 | [Συμμετοχικό περιεχόμενο](#συμμετοχικό-περιεχόμενο-2ο) | [10ο](href="#απαντήσεις-βίντεο-quiz-εβδομάδα-10η") |
| 11 | [Άσκηση γραμμής εντολών](#4η-άσκηση-γραμμής-εντολών) | [11ο](href="#απαντήσεις-βίντεο-quiz-εβδομάδα-11η") |
| 12 | [Τελική αναφορά](#) | [12ο](href="#απαντήσεις-βίντεο-quiz-εβδομάδα-12η") |
...
## Απαντήσεις βίντεο quiz Εβδομάδα 11η
   ...
   - **Question:** "Πως διαφέρουν οι προδιαγραφές στο σύστημα που δείχνει από τα σύγχρονα λειτουργικά και εφαρμογές;"<br>**Answer:** 

   - **Question:** "Γιατί θα πρέπει το λογισμικό να αναπτύσεται με την διαδοχική συγγραφή εικονικών μηχανών;"<br>**Answer:** 

   - **Question:** "Ποια είναι η διαφορά του συστήματος που δείχνει από τα σύγχρονα λειτουργικά και τον παγκόσμιο ιστό;"<br>**Answer:** 

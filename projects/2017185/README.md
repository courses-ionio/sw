...
**Question:** "Με ποιο τρόπο συνεργαστήκατε σε ιδέες δικές σας και άλλων σε αυτό το μάθημα;"<br>**Answer:** 

**Question:** "Το καλύτερο μάθημα που παρακολούθησε ο Alan Kay ως φοιτητής του έδωσε γνώσεις πάνω σε συστήματα που υπήρχαν;"<br>**Answer:** 
...
**Question:** "Με ποιο τρόπο το μάθημα μας εφαρμόζει στην πράξη τις συμβουλές του Αλαν Κέη αναφορικά με την αξία παλιών ιδεών και εργαλείων;"<br>**Answer:**

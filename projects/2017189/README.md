...
Σε αυτή την άσκηση μας ζητήθηκε να παρακολουθήσουμε την πορεία ενός προγράμματος σε python και να οπτικοποιήσουμε τα αποτελέσματα της διαδικασ
σίας σε ένα γράφημα.Χρησιμοποίησα το py-spy για την υλοποίηση του ζητήματος,και τα αποτελέσματα της διαδικασίας φαίνονται παρακάτω:

...
Για το τέταρτο παραδοτέο έπρεπε να διαλέξουμε ένα νέο λογισμικό που να μη χρησιμοποιεί systemd. Αρχικά έχοντας χρησιμοποιήσει παλαιότερα το VM ware επέλεξα να το χρησιμοποίησω. Από τις πολλές επιλογές που υπήρχαν, το FreeBSD μου φάνηκε μια πολύ καλή επιλογή μοιάζει αρκετά με τα Linux. Στο πρώτο στάδιο κατέβασα το τελευταίο image του FreeBSD, και το έβαλα κατευθείαν στο VM. Στο δεύτερο στάδιο έκανα setup τα dependencies του συστήματος και δημιούργησα χρήστες. 

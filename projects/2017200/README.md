...
| --- | --- | --- | --- |
| [1](https://github.com/vivikara/sw/tree/2017200/projects/2017200#παραδοτεο-1) | [Φορκ και δημιουργία σελίδας τελικής αναφοράς](https://courses-ionio.github.io/help/guide/), [προσθήκη πίνακα περιεχομένων](https://raw.githubusercontent.com/courses-ionio/sw/master/README.md), [συγγραφή της εισαγωγής](https://courses-ionio.github.io/help/intro/), αποστολή της εισαγωγής [για σχολιασμό στην συζήτηση](https://github.com/courses-ionio/help/discussions/categories/show-and-tell) και καταγραφή του συνδέσμου συζήτησης δίπλα -->| [link παραδοτέου (Discussions)](https://github.com/courses-ionio/help/discussions/109) | Εμπρόθεσμη παράδοση 1ου παραδοτέου, πραγματοποιήσα το fork και δημιούργησα την σελίδα της τελικής αναφοράς.Επιπλέον έγραψα την αρχική εισαγωγή με τους στόχους που έχω για το μάθημα και έπειτα από την ενδιάμεση παρουσίαση την τροποποιήσα ώστε να ανταποκρίνεται πλήρως και να έχει μια συνολική εικόνα από τα video-quiz. | 
| [2](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-2) | [Βιογραφικό και δημιουργία ομάδας](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-2)  | [link παραδοτέου(Discussions)](https://github.com/courses-ionio/help/discussions/235) | Εμπρόθεσμη παράδοση 2ου παραδοτέου. Αρχικά εντάχθηκα σε μια ομάδα και έπειτα δημιούργησα το cv και τέλος εισήγαγα το βιογραφικό στο webring της ομάδας. |
| [3](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-3) | [Αίτημα ενσωμάτωσης στην ιστοσελίδα](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-3) | [link παραδοτέου(Discussions)](https://github.com/courses-ionio/help/discussions/669) | Για το τρίτο παραδοτέο αφού επέλεξα ποία αλλαγή θέλω να πραγματοποίησω στο site άνοιξα ένα issue και αφού πήρα green light συνέχισα στην πραγματοποίηση και στην δημιουργία του pull request. |
| [4](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-4) | [Άσκηση γραμμής εντολών](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-4) | [link παραδοτέου (Discussions)](https://github.com/courses-ionio/help/discussions/670) | Για το τέταρτο παραδοτέο εγκατέστησα το artix linux σε vm που είναι χωρίς systemd |
| [5](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-5) | [Συμμετοχικό περιεχόμενο A1+A2](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-5) | [link παραδοτέου (Discussions)](https://github.com/courses-ionio/help/discussions/674) | Για το 5ο παραδοτέο έκανα αλλαγές στο pibook και πρόσθεσα τον commodore128 |
| [6](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-6) | [Άσκηση γραμμής εντολών](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-6) | [link παραδοτέου (Discusions)](https://github.com/courses-ionio/help/discussions/671) | Για το 6ο παραδοτέο πραγματοποίησα την άσκηση γραμμής εντολών με το ntfy [telegram] |
| [7](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-7) | [βιογραφικό](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-7) | [link παραδοτέου (Discusions)](https://github.com/courses-ionio/help/discussions/672) | Για το 7ο παραδοτέο μετέτρεψα το cv σε pdf με την χρήση pandoc και latex |
...
| [10](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-10) | [συμμετοχικό περιεχόμενο B1+B2](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-10) | [link παραδοτέου (Discusions)](https://github.com/courses-ionio/help/discussions/673) | Για το 10ο παραδοτέο έκανα αλλαγές στο pibook και πρόσθεσα το alpinelinux και την βιογραφία του Bil Herd και έπειτα το pr στην ομάδα  |
| 11 | Άσκηση γραμμής εντολών | | |
| [12](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-12) | [Τελική αναφορά*](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-12) | [link παραδοτέου (Discusions)](https://github.com/courses-ionio/help/discussions/681) | Για την τελική αναφορά μου έγραψα τα συμπεράσματα μου για το μάθημα |
...
Στο μάθημα Τεχνολογία Λογισμικού στόχος μου είναι αρχικά να εξοικειωθώ όσο το δυνατόν περισσότερο με το εργαλείο Github καθώς θεωρώ ότι είναι πολύ σημαντικό για την μετέπειτα πορεία μου. Επιπλέον η προσδοκία μου από το μάθημα είναι η κατασκευή ιστοσελίδων μέσω  του Github και η εκμάθηση συνεργατικότητας και ειδικότερα η σωστή μεθοδολογία δουλειάς μέσα σε μια ομάδα. Επίσης θα ήθελα  να εξελίξω τις γνώσεις μου στο Linux.Τα video quiz μου προσφέρουν μία διαφορετική εμπειρία που,δεν έχω την τύχη να παρακαλουθώ άλλα μαθημάτα,σε σύγκριση με την ανάγνωση θεωρίας και εκμάθηση αυτολεξή κάποιων παραγμάτων.Με την χρήση ερωτήσεων κατα την διάρκεια των video προσφέρεται στον καθηγητή η δυνατότητα να παρακολουθεί και να αξιολογεί τη πρόοδο του φοιτητή. Με αυτόν τον τρόπο υπάρχει η δυνατότητα υπολογισμού της αποτελεσματικότητας στο κομμάτι της θεωρίας.

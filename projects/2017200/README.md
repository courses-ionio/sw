...
| [2](https://github.com/vivikara/sw/blob/2017200/projects/2017200/README.md#παραδοτεο-2) | Βιογραφικό και δημιουργία ομάδας  | [link παραδοτέου(Discussions)](https://github.com/courses-ionio/help/discussions/235) | Εμπρόθεσμη παράδοση 2ου παραδοτέου. Αρχικά εντάχθηκα σε μια ομάδα και έπειτα δημιούργησα το cv και τέλος εισήγαγα το βιογραφικό στο webring της ομάδας. |

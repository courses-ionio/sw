...
AM: Π2017202
 ...
 ## Συμμετοχικό Υλικό
  ...
  [Link αντιγράφου αποθετηρίου](https://github.com/AlexandrosP38/gr)
   ...
   Μέρος της εργασίας στην Τεχνολογία Λογισμικού είναι η προσθήκη 2 εικόνων με έλευθερα πνευματικά δικαιώματα στο ["O Προγραμματισμός της Διάδρασης"](https://www.mibook.org/)
  ...
  [Link της σελίδας μου](https://alexandrosp38.github.io/gr/)
   ...
   H τρίτη εργασία του συμμετοχικού υλικού είναι η βιογραφια του James Gosling. Είναι παγκοσμίως αναγνωρισμένος ως ο πατέρας της γλώσσας προγραμματισμού Java. H γλώσσα αυτή είναι μια καινοτόμος γλώσσα, αρχικά απλή, αντικειμενοστραφής και οικεία και, ταυτόχρονα, στιβαρή, ασφαλής και αποσπασμένη από οποιαδήποτε αρχιτεκτονική υλικού. 
   
   [Link βιογραφίας/ James Gosling](https://alexandrosp38.github.io/gr/biography/james-gosling/)

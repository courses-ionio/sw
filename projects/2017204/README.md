...
### Στη συγκεκριμένη εργασία χρησιμοποίησα ένα λάπτοπ με λειτουργικό Ubuntu 16.04 και ένα Raspberry pi 4b με λειτουργικό Raspbian. Αφού πρώτα έκανα όλη την παραπάνω διαδικασία σχετικά με την εγκατάσταση, αμέσως μετά ενεργοποίησα το ssh στο raspberry pi 4b με την εντολή sudo raspi-config και επέλεξα ενεργοποίηση του ssh. Τέλος, χρησιμοποίησα το username του raspberry pi 4b και την διευθυνση ip, όπως φαίνεται παρακάτω στην εικόνα.

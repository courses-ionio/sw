...
| <ul><li>- [ ] </li></ul> | [8](#Παραδοτέο-8) | Αίτημα ενσωμάτωσης στην ιστοσελίδα |
...
- Άνοιξα [issue](https://github.com/ioniodi/sitegr/issues/175) που περιγράφει τη συνεισφορά (περιμένω ετικέτα "green light")
...
Θα προχωρήσω στις απαραίτητες ενέργειες αφού πάρω ετικέτα green light και λύσω τις απορίες που έθεσα στο issue που ανέφερα παραπάνω.

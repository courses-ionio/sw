...
# ΑΠΑΝΤΗΣΕΙΣ ΣΤΟ 3ο ΒΙΝΤΕΟ (KAY - COMPUTING - SIMPLY):

## Ποιες ήταν οι βασικές ιδέες που επηρέασαν τον Αλαν Κεη στην κατασκευή νέου λογισμικού;
Η ιδέα κατασκευής νεόυ λογισμικού προήλθε 1ον από τον Bob Barton ο οποίος κατασκεύασε έναν υπολογιστή που θα μπορούσαν οι άνθρωποι να γράφουν γλώσσες προγραμματισμού υψηλού επιπέδου και 2ον από τον McCarthy ο οποίος στοχάστηκε τρόπους οργάνωσης των μεθόδων για την φημιουργία σωστού λογισμικού. Έτσι ο Αλαν εμπνεύστηκε ώστε να οπτικοποιήσει τα παραπάνω. 
...
Η δημιουργία των etoys εμπνεύστηκε από την επιθυμία να υπάρχει μια γενική προσομοίωση πολλών αντικειμένων σε έναν χώρο. Βασική ιδέα πίσω από το σύστημα ήταν οτι όλο αυτό ήταν αναδρομικό και δεν χανόταν η όποια επεξεργασία γινόταν. 

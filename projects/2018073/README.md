...
| Εβδομάδα | Παραδοτέο |
| --- | --- |
| [1](#παραδοτεο-1---εισαγωγή) | Φορκ του αποθετηρίου και δημιουργία της σελίδας της αναφοράς με τα προσωπικά στοιχεία σας, της σύνοψης με αυτόν τον πίνακα περιεχομένων, και συγγραφή της εισαγωγής με περιγραφή των αναγκών και των στόχων σας για το αντίστοιχο μάθημα |
| 2 | βιογραφικό |
...
## <a name="P">ΠΑΡΑΔΟΤΕΟ 2 - Βιογραφικό:</a>
...
## <a name="P">ΠΑΡΑΔΟΤΕΟ 3 - Δημιουργία πρώτου pull request στο ανεπίσημο site της σχολής:</a>
...
## <a name="P1">ΠΑΡΑΔΟΤΕΟ 5 - Προσθήκη δύο εικόνων στο pibook.epidro.me</a>
...
## <a name="P">ΠΑΡΑΔΟΤΕΟ 7 - Κουμπί τύπωσης PDF στο βιογραφικό:</a>
 ...
 ## <a name="P">ΠΑΡΑΔΟΤΕΟ 8 - Δημιουργία δεύτερου pull request στο ανεπίσημο site της σχολής:</a>
...
## <a name="P">ΠΑΡΑΔΟΤΕΟ 10 - Προσθήκη μελέτης περίπτωσης και βιογραφία στο pibook (site)</a>

...
## <a name="P">ΠΑΡΑΔΟΤΕΟ 7 - Κουμπτί τύπωσης PDF στο βιογραφικό:</a>
 ...
 Η ιστοσελίδα διαθέτει ήδη δυναμικό χαρακτήρα, από το αντίστοιχο παραδοτέο δημιουργίας της και για αυτό τον λόγω δεν χρειάστηκε κάποια τροποποίηση σε αυτό το κομμάτι. Οι αλλαγές ενσωματόνονται στην ζωντανή ιστοσελίδα μέσα σε 5-10 δευτερόλεπτα από την πραγματοποίησή τους, χωρίς να απαιτήται επαναπροσδιόριση του συνδέσμου.

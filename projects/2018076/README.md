...
| 10 | Τελική αναφορά* | [Link to discussions](https://github.com/courses-ionio/sw/discussions/1521) | Η κατεύθυνση της εστίασης από το υλικό στο λογισμικό ήταν μια πρόκληση που ολοκληρώθηκε σε ικανοποιητικό επίπεδο |

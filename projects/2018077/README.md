...
Έκανα 4 ασκήσεις γραμμής εντολών, 1 επιτυχές αίτημα ενσωματώσης στην ιστοσελίδα, 1  επιτυχές έτυμα ενσωματώσεις στην ιστοσελίδα, 2 προσθήκες συμμετοχικού υλικού, 2 ασκήσεις που αφορούσαν την δημιουργία βιογραφικού, παρακολούθησα και απάντησα όλα τα εβδομαδιαία βίντεο, παρακολούθησα τις διαλέξεις μέσω του εργαλείου τηλεκπαίδευσης zoom και πραγματοποίησα 3 συναντήσεις με τον κύριο Πατηνιώτη Κωνσταντίνο για να του παρουσιάσω την πρόοδό μου. 
...
*Συμπέρασμα:*\
Ο στόχος μου για το μάθημα ήταν η μελέτη για την σωστή και αποδοτική δημιουργία λογισμικού, γεγονός που επιτεύχθηκε. Είδαμε πολλά παραδείγματα  λογισμικού είτε στις διαλέξεις είτε στις βιντεοδιαλέξεις και συγκρίναμε τους τρόπους δημιουργίας του λογισμικού του τότε με το σήμερα. Παράλληλα, μου δόθηκε η ευκαιρία να δω με μεγαλύτερη προσοχή την σημαντικότητα των  open source λογισμικών.  Λόγω του ότι έπρεπε να χρησιμοποιήσουμε το Github και το Git με βοήθησε να μάθω καλύτερα το τι προσφέρει αυτό το εργαλείο και να το χειρίζομαι, γεγονός που θα με βοηθήσει και στα προσωπικά μου project. Ως highlight του μαθήματος θεωρώ το εργαλείο jekyll που ενώ στην αρχή με δυσκόλεψε αρκετά με έμαθε έναν νέο τρόπο με τον οποίο μπορώ να δημιουργώ ιστοσελίδες. Σε αυτό συνέβαλε η άσκηση με την δημιουργία ενός YAML αρχείου για το βιογραφικό μας αλλά και οι ασκήσεις που αφορούσαν την συνεισφορά στην ιστοσελίδα. Είχε ενδιαφέρον να μελετάς ένα έτοιμο project που στηρίζεται στην λογική του jekyll. 

...
| 12 | [Σύνοψη και Συμπέρασμα ](#Σύνοψη-και-Συμπέρασμα ) |
...
**Στόχοι :**
Σύμφωνα με την βιβλιογραφία, του [λίνκ του μαθήματος στην ιστοσελίδα του τμήματος](https://di.ionio.gr/gr/studies/undergraduate-studies/courses/614/) , το [GitHub λίνκ](https://github.com/courses-ionio/sw) και μετά από τα εισαγωγικά μαθήματά, προσδοκώ την ενασχόληση με τον τρόπο κατασκευής λογισμικού. Ουσιαστικά, θα είναι η “συνέχεια” από το αντίστοιχο μάθημα Επικοινωνία Ανθρώπου Υπολογιστή. Στο προηγούμενο μάθημα, ασχοληθήκαμε με το πως γίνετε η δίαδραση  και τώρα θα εστιάσουμε στον τρόπο με τον οποίο πραγματοποιείται. Αλώστε, σύμφωνα με τις ασκήσεις που έχουμε κληθεί να παραδώσουμε εντός του εξαμήνου αποδεικνύεται η φύση του μαθήματος.
...
*Σύνοψη:*\
Υπάρχει ένας πίνακας με τα παραδοτέα της κάθε εβδομάδας και ένας δεύτερος πίνακας στον οποίο αναγράφονται τα βίντεο που έχουν απαντηθεί και αν έχουν απαντηθεί μέσο της εφαρμογής ή στο Readme.\
Έκανα 4 ασκήσεις γραμμής εντολών, 1 επιτυχές έτυμα ενσωματώσεις στην ιστοσελίδα, 1  επιτυχές έτυμα ενσωματώσεις στην ιστοσελίδα, 2 προσθήκες συμμετοχικού υλικού, 2 ασκήσεις που αφορούσαν την δημιουργία βιογραφικού, παρακολούθησα και απάντησα όλα τα εβδομαδιαία βίντεο, παρακολούθησα τις διαλέξεις μέσο του εργαλείου τηλεκπαίδευσης zoom και πραγματοποίησα 2 συναντήσεις με τον κύριο Πατινιότη Κωνσταντίνο για να του παρουσιάσω την πρόοδό μου. 
Τα παραδοτέα του συμμετοχικού υλικού συνδέονται με τον εξής τρόπο. Γλώσσες που αφορούν τα πολυμέσα και προϊόντα/ανθρώπους που αφορούν την εταιρία Raspberry Pi. Μάλιστα, η μία γλώσσα είναι ένα προϊόν της Raspderry Pi. Εκτός αυτού, το Pi OS είναι ένα πολυμεσικό λειτουργικό.

*Συμπέρασμα:*\
Ο στόχος μου για το μάθημα ήταν η μελέτη για την σωστή και αποδοτική δημιουργεί λογισμικού, γεγονός που επιτεύχθηκε. Είδαμε πολλά παραδείγματα  λογισμικού είτε στις διαλέξεις είτε στις βιντεοδιαλέξεις και συγκρίναμε τους τρόπους δημιουργίας του λογισμικού του τότε με το σήμερα. Παράλληλα, μου δόθηκε η ευκαιρία να δω με μεγαλύτερη προσοχή την σημαντικότητα των  open source λογισμικών.  Λόγο του ότι έπρεπε να χρησιμοποιήσουμε το Github και το Git με βοήθησε να μάθω καλύτερα το τι προσφέρει αυτό το εργαλείο και να τι χειρίζομαι, γεγονός που θα με βοηθήσει και στα προσωπικά μου project. Ως high lite του μαθήματος θεωρώ το εργαλείο jekyll που ενώ στην αρχή με δυσκόλεψε αρκετά με έμαθε έναν νέο τρόπο με τον οποίο μπορώ να δημιουργώ ιστοσελίδες. Σε αυτό συνέβαλε η άσκηση με την εριουργεία ενός YAML αρχείου για το βιογραφικό μας αλλά και οι ασκήσεις που αφορούσαν την συνεισφορά στην ιστοσελίδα. Είχε ενδιαφέρον να μελετάς ένα έτυμο project που στηρίζετε στην λογική του jekyll. 

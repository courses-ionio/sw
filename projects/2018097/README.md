...
<ins> Άσκηση γραμμής εντολών </ins> <br>
Για την εργασία γραμμής εντολών αυτής της εβδομάδας, επέλεξα να κάνω την 6η προτεινόμενη εργασία και να πραγματοποιήσω μια κλήση, μέσω της εφαρμογής Twilio. Αφού έγινε η εγκατάσταση των απαιτούμενων πακέτων, μέσω ενός script, πραγματοποιήθηκε η κλήση. 

...
Για την μετατροπή του βιουργαφικού από την ιστοσελίδα σε pdf, έχω συναντήσει ένα κύριο εμπόδιο. Μέσω τερματικού με την εντολή pandoc, δεν μπορώ να κάνω την μετατροπή διότι υπάρχει ένα .shtml αρχείο. Αυτό το αρχείο έψαξα να το βρω αλλά δεν μπόρεσα.

...
να διαθέτει ανοιχτή σκέψη και γενικά να είναι σε θέση να δοκιμάζεί νέες ιδέες και να μην βασιζέται εξ ολοκλήρου σε έτοιμα εργαλεία και μεθόδους. Πολύ ενδιαφέρον και
...
με τα υπόλοιπα μέλη της ομάδας δεν εξελιχθηκε όπως θα έπρεπε,πράγμα στο οποίο φέρνω και εγώ ευθύνη.Το μάθημα αυτό αποτελεί μια πολύ καλή αρχή στον κόσμο του ελεύθερου και

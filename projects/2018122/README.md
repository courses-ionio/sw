...
Ολοκληρώνοντας το μάθημα και παράλληλα τις εργασίες του μαθήματος Τεχνολογία Λογισμικού :technologist: μπορώ να πώ με σιγουριά πως έλαβα γνώση πάνω στο αντικείμενο εκπληρώνοντας και τις προσδοκίες που είχα από την αρχή αυτού. Αρχικά η περεταίρω εξοικοίωση μου με την πλατφόρμα του Github και τα περιεχόμενα των παραδοτέων για τον σκοπό των εβδομαδιαίων εργασιών που εντάχθηκαν στο "portfolio" μου μπορούν να παίξουν ρόλο στην επαγγελματική μου καριέρα . Έπειτα έιχα την ευκαιρία να δουλέψω με τα συστήματα Linux σε systemd & nosystemd σε Arch Linux & Void Linux αντίστοιχα ολοκληρώνοντας τα παραδοτέα στο καλύτερο των δυνατοτήτων μου . Τέλος θεωρώ τον χρόνο που αφιέρωσα για τα παραδοτέα και τα βίντεο ευεργετικό για την ανάπτυξη των γνώσεων μου και του skillset μου.

# Ομαδικότητα

### Συνεισφορά στα discussions
-https://github.com/courses-ionio/sw/pull/1670
-https://github.com/courses-ionio/sw/pull/1660

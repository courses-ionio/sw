...
| 11 | Άσκηση γραμμής εντολών | [LINK](https://github.com/courses-ionio/help/discussions/621) | Πήρα σημαντικές πληροφορίες για κάποια εργαλεία και πιστεύω ότι εν τέλη θα κάνω πιο συχνή χρήση τους. |
| 12 | Τελική αναφορά | | Κατανόησα πως το μάθημα σίγουρα με βοήθησε στο να δουλέψω με έναν διαφορετικό τρόπο και να εξοικειωθώ με νέες τεχνικές |

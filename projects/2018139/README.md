...
| [7]() | Συμμετοχικό περιεχόμενο B1 | [Συζήτηση](https://github.com/courses-ionio/sw/discussions/1632) |Ολοκληρώθηκε επιτυχώς|
| [8]() | Κατασκευή του βιβλίου Β2 (συνεργατικά) | [Συζήτηση](https://github.com/courses-ionio/sw/discussions/1633)  |Ολοκληρώθηκε επιτυχώς|
| [9]() | Συμμετοχικό περιεχόμενο B2 | [Συζήτηση](https://github.com/courses-ionio/sw/discussions/1663) |Ολοκληρώθηκε επιτυχώς|
| [10]() | Τελική αναφορά* | [Συζήτηση](https://github.com/courses-ionio/sw/discussions/1664) |Ολοκληρώθηκε επιτυχώς|
...
Από το μάθημα τεχνολογία λογισμικού βελτιώθηκα στην χρήση του github αλλά έμαθα και το πώς μπορώ να φτιάξω το δικό μου blog ή το δικό μου ολοκληρομένο site. Επιπλέον μου δόθηκε το βήμα για έρευνα απο τα εβδομαδιαία βίντεο κουίζ και απέκτησα γνώση για συμαντικούς ανθρώπους οι οποίοι άλλαξαν την πληροφορική.
 ...
 ## ΣΥΝΗΣΦΟΡΑ ΚΑΙ ΣΥΝΕΡΓΑΣΙΑ ΣΤΑ PULL REQUEST
 
 - [COMMENT 1](https://github.com/courses-ionio/sw/pull/1693)
 - [COMMENT 2](https://github.com/courses-ionio/sw/pull/1701)

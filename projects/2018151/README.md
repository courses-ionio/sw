...
| --- | --- | --- |
| 1 | <a href="#P-1">Φορκ του αποθετηρίου και δημιουργία της σελίδας της αναφοράς με τα προσωπικά στοιχεία σας, της σύνοψης με αυτόν τον πίνακα περιεχομένων, και συγγραφή της εισαγωγής με περιγραφή των αναγκών και των στόχων σας για το αντίστοιχο μάθημα</a>| <ul><li>- [x] </li></ul>  |
| 2 | <a href="#P-2"> Βιογραφικό</a> |<ul><li>- [x] </li></ul>  |
| 3 | <a href="#P-3">Αίτημα ενσωμάτωσης στην ιστοσελίδα</a> |<ul><li>- [x] </li></ul>  |
| 4 | <a href="#P-4">Άσκηση γραμμής εντολών</a> |<ul><li>- [x] </li></ul>  |
| 5 | <a href="#P-5">Συμμετοχικό περιεχόμενο</a> |<ul><li>- [x] </li></ul>  |
| 6 | <a href="#P-6">Άσκηση γραμμής εντολών</a> |<ul><li>- [x] </li></ul>  |
| 7 | <a href="#P-7">Βιογραφικό</a> |<ul><li>- [x] </li></ul>  |
| 8 | Αίτημα ενσωμάτωσης στην ιστοσελίδα |
| 9 | <a href="#P-9">Άσκηση γραμμής εντολών</a> |<ul><li>- [x] </li></ul>  |
| 10 | <a href="#P-10">Συμμετοχικό περιεχόμενο</a> |<ul><li>- [x] </li></ul>  |
| 11 | <a href="#P-11">Άσκηση γραμμής εντολών</a> |<ul><li>- [x] </li></ul>  |
| 12 | <a href="#P-12">Τελική αναφορά</a> |<ul><li>- [x] </li></ul>  |
...
## <a name="P-12">Παραδοτέο 12 - ΤΕΛΙΚΗ ΑΝΑΦΟΡΑ:</a>

Στο μάθημα Τεχνολογίες Λογισμικού πιστεύω σε ένα σημαντικό βαθμό συνάντησα και πήρα μία βασική εμπειρία από τους στόχους και προσδοκίες που είχα θέσει στην αρχή. Απέκτησα γνώσεις και έμαθα τεχνολογίες τις οποίες δεν γνώριζα ότι θα με ενδιαφέρουν και σίγουρα θέλω να τις εξελίξω στο μέλλον. 

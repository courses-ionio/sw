...
Για το 7ο παραδοτέο πρόσθεσα την δυνατότητα εκτύπωσης του βιογραφικού μου σε μορφή pdf A4 μέσω κουμπιού που εμφανίζεται. Την προσθήκη αυτού του κουμπιού την έκανα με την βοήθεια του weasyprint γιατί δεν είχα - απο άποψη hardware- την δυνατότητα χρήσης pandoc+latex. Επίσης έφτιαξα ένα script για pre-commit και post-commit που ενσωματώνει κάθε αλλαγή που γίνεται στα αρχεία ymal ή html ώστε κάθε τροποποίηση θα ενσωματώνεται αυτόματα και στο αρχείο pdf με κάθε commit που κάνω.

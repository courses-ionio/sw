...
| 12 | [Τελική αναφορά](#συμπεράσματα) |
...
Έχω κατανοήσει σε εξαιρετικά βαθμό ***docker*** και ***Linux***, όλες οι εφαρμογές και οι δυνατότητες που παρέχονται καλύπτουν ικανοποιητίκα σχεδόν οποιαδήποτε ανάγκη στον τομέα της πληροφορικής. Με τα παραπάνω λογισμικά εξοικειώθηκα και σε πρακτικό  και θεωρητικό κομμάτι, μέσω των εργασιών είτε σε ασκήσεις τερματικού είτε σε στα υπόλοιπα παραδοτέα ενημερώθηκα σε θέματα λογισμικού και ανέπτυξα τις δεξιότητες μου στα αντικείμενα αυτά. Η εξέλιξη μου φαίνεται μέσα από το Github, όχι μόνο σε προγραμματιστικό βαθμό αλλά και σε επιπέδο συνεργασίας μεταξύ συμφοιτητών μου ανάμεσα σε project όπως σε μία τεράστια επιχείρηση.

...
---
Ενδιάμεση πρόοδος με τον κύριο Βραχάτη: Πραγματοποιήθηκε 15 Φεβρουαρίου
* Συζήτηση για τα βίντεο κουίζ
* Αναλυτική επεξήγηση των παραδοτέων 
* Προβλήματα που αντιμετώπισα: μου πρότεινε κάποιες λύσεις για το pandoc, δυστυχώς δε δούλεψε.
* Τόνισε την σημαντικότητα του οργανισμού και των ομαδικών παραδοτέων
* Αναφερθήκαμε στην ομάδα μου, τόσο στον τρόπο συνεργασίας όσο και στην ποιότητα.
...
* Σχόλια σε pull request συναδέλφων: [NickLithari](https://github.com/courses-ionio/sw/pull/1625#issuecomment-1549333554), [](https://github.com/courses-ionio/sw/pull/1640#issuecomment-15514048)

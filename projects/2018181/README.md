...
Σύμφωνα με  τον Αλαν Κευ, σ’ ένα μάθημα υπολογιστών παγίδα αποτελεί η τακτική των καθηγητών να διορθώνουν απλά τα σφάλματα των μαθητών, ενώ θα ήταν ωφέλιμη η  παράθεση τους. 
</br>
</details>
<details>

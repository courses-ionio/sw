...
* [x] Ταξινόμηση με αλγόριθμο Quicksort μέσω python script του πίνακα με αριθμούς [] (quicksort.py)
...
* [x] Τροποποίηση του python script για ταξινόμηση πίνακα μεγαλύτερου μεγέθους. 

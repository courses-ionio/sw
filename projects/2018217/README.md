...
* Κατανόηση λειτουργίας __Submodules__ για κοινή χρήση και ενημέρωση εξωτερικού αποθετηρίου (πχ αποθετηρίου βιβλίου) με ταυτόχρονη διαχείριση όλων των πόρων τους με πολλές υπο-εντολές (add, update,sync κλπ).
  * (Παραδοτέα 5 & 10)
* Αξιοποίηση εργαλείων ειδοποιήσεων με χρήση συκεκριμένων παραμέτρων για δρομολόγηση των ειδοποιήσεων στο κινητό/PC. (Slack & Telegram)
  * (Παραδοτέα 6 & 9)
...
Για την υλοποίηση των προτύπων αυτών ήταν απαραίτητες κάποιες προϋποθέσεις, η κυριότερη από τις οποίες αφορούσε την καθημερινή προετοιμασία ώστε γνωστικά και πρακτικά να αξιοποιήσουμε τα εργαλέια αυτά στην πράξη. 

...
- Αυτή η <a href="https://github.com/p18mili1/Image_Processing_Lab/blob/main/images/Paradoteo_9.png">εικόνα</a> είναι στιγμιότυπο της οθόνης του Η/Υ μου στο οποίο φαίνεται αριστερά το terminal, το οποίο είναι χωρισμένο σε δυο τμήματα, δεξιά τα μηνύματα στο slac και πάνω δεξιά η ειδοποίηση από το slac προς το desktop.

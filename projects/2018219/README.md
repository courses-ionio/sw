...
Αρχικά έκανα κλωνοποίηση του αποθετηρίου μου MyCV από το github τοπικά στον Η/Υ μου. Στη συνέχεια έκανα τροποποιήσεις στα αρχεία `_confgig.yml`, `_data/data.yml` και `_sass/base.scss` συνοδευόμενες από τις αντίστοιχες εντολες "git add" και "git commit" για το καθένα. Τέλος, ενημέρωσα την "online" σελίδα με τις νέες αυτές αλλαγές με την εντολή "git push".
...
- Αρχικά δημιούργησα ένα λογαριασμό στο <a href="https://slack.com">slack</a>, έφτιαξα το workspace IONIO_SW και όρισα σε αυτό το channel paradote9 και το app `mqtt-notif-app`.
- Ακολούθως εγκατέστησα τον **mqtt broker mosquitto** και τους αντίστοιχους **clients**
- Στη συνέχεια, εγκατέστησα την υπηρεσία **mqttwarn** κι έκανα τις σχετικές προσθήκες στο αρχείο _mqttwarn.ini_ ώστε να στέλνονται οι ειδοποιήσεις στο _slack app_ του λογαρισμού μου. Έτσι γράφοντας ένα μήνυμα στο τερματικό από τον _mosquitto client_, αυτό μέσω της υπηρεσίας _mqttwarn_ αποστέλλεται στο _slack_ και κατ'επέκταση σε όσους έχω προσθέσει στη λίστα παραλαβής του καναλιού μου.
- Στην παρακάτω εικόνα φαίνεται το στιγμιότυπο της οθόνης του Η/Υ μου χωρισμένο σε δυο μέρη. Στα αριστερά είναι το terminal, το οποίο έχει χωριστεί σε δυο επιμέρους terminals. Στο πάνω terminal φαίνεται η εκτέλεση του mqttwarn και στο κάτω η εκτέλεση του mosquitto client που στελνει το μήνυμα. Στα δεξιά διακρίνονται τα μηνύματα του καναλιού paradoteo9 στο slac και πάνω δεξιά η ειδοποίηση από το slac προς το desktop του Η/Υ. Η εμφανιση δυο  terminal window σε ένα έχει γίνει για να φαίνoνται μαζί στην ιδια εγγραφή του asciinema και έχει επιτευχθεί με τη βοήθεια της εφαρμογής `screen`.

![Paradoteo_9](https://user-images.githubusercontent.com/56065057/118616047-062fba00-b7ca-11eb-8cfd-70241d6bf222.png)
...
<table>
  <tbody>
    <tr>
        <td align="left"><a href="https://github.com/p18mili1/extras/tree/b09059065942d9d33e9140db965900b22660db58">Σύνδεσμος submodule extras</a></td>
        <td align="left">Αρχείο <a href="https://github.com/p18mili1/extras/blob/b09059065942d9d33e9140db965900b22660db58/cs-google-translate.md">cs-google-translate.md</a></td>
    </tr>
    <tr>
        <td align="left"><a href="https://github.com/p18mili1/images/tree/9d52c2daea69a5afc31d486ff2fffbf2555ca89b">Σύνδεσμος submodule images</a></td>
        <td align="left">Eικόνα <a href="https://github.com/p18mili1/images/blob/9d52c2daea69a5afc31d486ff2fffbf2555ca89b/ted-kaehler.png">ted-kaehler.png</a>, Eικονίδιο <a href="https://github.com/p18mili1/images/blob/9d52c2daea69a5afc31d486ff2fffbf2555ca89b/ted-kaehler-thumb.png">ted-kaehler-thumb.png</a></td>
    </tr>
    <tr>
        <td align="left"><a href="https://github.com/p18mili1/site">Σύνδεσμος αποθετηρίου site</a></td>
        <td align="left"></td>
    </tr>
    <tr>
        <td align="left">Αρχείο που έχει προστεθεί στον κατάλογο <a href="https://github.com/p18mili1/site/tree/master/_case-study">_case-study</a></td>
        <td align="left"><a href="https://github.com/p18mili1/site/blob/master/_case-study/google-translate.md">google-translate.md</a></td>
    </tr>
...
<table>
  ...
  - <a href="https://mybookp18mili1.netlify.app">Σύνδεσμος netlify του βιβλίου</a>
  - Eκτελέσιμα netlify: 
    - https://mybookp18mili1.netlify.app/biography/
    - https://mybookp18mili1.netlify.app/biography/ted-kaehler/
    - https://mybookp18mili1.netlify.app/case-study/
    - https://mybookp18mili1.netlify.app/case-study/google-translate/
...
<table>
  ...
  dst_gray, dst_color = cv2.pencilSketch(img,sigma_s=20,
                        sigma_r=0.05, shade_factor=0.09) 
  gname = 'gray_' + fname
  cname = 'color_' + fname
  cv2.imwrite(gname, dst_gray)
  cv2.imwrite(cname, dst_color)
  ...
  fname = sys.argv[1]
  img = cv2.imread(fname)
  res = cv2.stylization(img,sigma_s = 60,
                        sigma_r = 0.3)
  nname = 'new_' + fname
  cv2.imwrite(nname, res)
...
<table>
  ...
  daisy.json
  {
    "results": [
      {
        "command": "python3.9 sketch.py daisy.png",
        "mean": 0.352064500655,
        "stddev": 0.0029947539976929805,
        "median": 0.352505993655,
        "user": 0.40549588000000003,
        "system": 0.28215275,
        "min": 0.348443246155,
        "max": 0.35734563815500003,
        "times": [
          0.348808731155,
          0.35734563815500003,
          0.353045338155,
  ...
  face.json
  {
    "results": [
      {
        "command": "python3.9 sketch.py face.jpg",
        "mean": 0.6001125934000001,
        "stddev": 0.004464483538842638,
        "median": 0.602607654,
        "user": 0.6213426750000001,
        "system": 0.34398582999999994,
        "min": 0.5929220690000001,
        "max": 0.6047856890000001,
        "times": [
          0.5936058580000001,
          0.602473035,
          0.602742273,
...
- Κατά την εκτέλεση του py-spy γίνεται εξαγωγή των αποτελεσμάτων σε αρχεία svg που περιέχουν flame graphs.
  ...
  ![Screenshot](https://github.com/p18mili1/Image_Processing_Lab/blob/main/images/daisy.svg)
  ![Screenshot](https://github.com/p18mili1/Image_Processing_Lab/blob/main/images/face.svg)
...
## <a href="#P">Συμπεράσματα</a>
Από την αρχή του εξαμήνου φάνηκε ότι η χρήση της πλατφορμας του github θα ήταν το πεδίο δράσης μας. Ανακάλυψα πολλές χρήσιμες λειτουργίες, τις οποίες μάλιστα χρησιμοποίησα δεόντως και σε άλλα μαθήματα αφού η συνεργασία εξ' αποστάσεως με άλλους συμφοιτητές μου έγινε πραγματικά πολύ εύκολη. Πέραν του github, υπήρξε μεγάλη εξοικείωση με τη γραμμή εντολών και τα διάφορα εργαλεία που μπορεί να κάποιος χρησιμοποιήσει σε αυτή, όπως οι εφαρμογές ειδοποιήσεων σχετικά με την εξέλιξη μιας διεργασίας ή αυτοματοποιημένη λειτουργία ενημέρωσης από το το τοπικό αποθετήριο μέχρι το deployed site. Γενικά, έμαθα πολύ περισσότερα από όσα ίσως περίμενα αλλά το τίμημα σε χρόνο ήταν βαρύ. Θα ήθελα λίγο περισσότερη καθοδήγηση σε κάποια σημεία για να μπορώ να μάθω περισσότερα και σίγουρα λιγότερα βίντεο. 
...
### 6ο Bίντεο-κουίζ
  ...
  - Δεδομένου ότι τα αντικείμενα που κατασκευάζει η πληροφορική, τα υλοποιεί ακολουθώντας τα πρότυπα επιστημών όπως η φυσική, η χημεία, κτλ, δηλαδή μετά από μελέτη, ανάλυση, μετρήσεις, δοκιμές και βελτιώσεις, μπορεί να θεωρηθεί ως επιστήμη. Ταυτόχρονα όμως, επειδή η έννοια της δομής των κατασκευών είναι ταυτόσημη με τα αντικείμενα που κατασκευάζει η πληροφορικής, μπορεί να θεωρηθεί και κλάδος των μηχανικών ικανοποιώντας τα κριτήρια για να ανήκει και στους δύο αυτούς κλάδους. 
  - Επειδή οι άνθρωποι δυσκολεύονται να αποδεχθούν το καινούργιο και ιδιαίτερα οτιδήποτε δεν προέρχεται από το κυρίαρχο φυσικό και μη περιβάλλον.
  - Η πρώτη ήταν οι εξισώσεις του Maxwell οι οποίες παρά τον τεράστιο όγκο σε μελέτη υποδομής που χρειάστηκε για να αναπτυχθούν, το τελικό αποτέλεσμα είναι απλό και μικρό σε μέγεθος. Η δεύτερη ήταν το σύνταγμα των ΗΠΑ, το οποίο παρότι είναι ένα μικρού μεγέθους βιβλίο που περιγράφει θεμελιώδεις αρχές, αλλά όχι την υλοποίησή τους, καταφέρνει να "τρέχει" μία τόσο πολυσύνθετη χώρα για τόσα χρόνια.
  - Ένα βασικό πρόβλημα είναι ο μη παραγωγικός τρόπος σκέψης των μαθητών στο οποίο έχουν καταλήξει εξαιτίας του τρόπου με τον οποίο έχουν αποκτήσεις την γνώση που ήδη έχουν, δηλαδή ως μασημένη τροφή. Η πληροφορική είναι μια μια ενιαία οντότητα και όχι υπολογιστές και γλώσσες και διαδικασίες και ως τέτοια θα έπρεπε να διδάσκεται.
  - Ο αντικειμενοστραφής προγραμματισμός του Άλαν Κέη θεωρεί ότι όλα είναι το ίδιο αντικείμενο απλά με διαφορετικό κοστούμι το καθένα.

### 8ο Bίντεο-κουίζ
- Η τεχνολογική λύση που προτείνεται είναι ένα νόμισμα με τη μορφή ψηφιακού συστήματος στο οποίο η πρόσβαση θα είναι ισότιμη για όλους και το ίδιο το σύστημα θα κρίνει τη προσφορά του καθενός ανάλογα με τη συνεισφορά του στο κοινωνικό σύνολο.
- Γιατί σε δικτυωμένους υπολογιστές, αφενός μεν η πληροφορία είναι συνέχεια διαθέσιμη (online) και ενημερωμένη, αφετέρου δε είναι καταγεγραμμένο και όλο το ιστορικό από τη στιγμή της δημιουργίας της ή της πρωτης εμφάνισής της.
- Το πρόβλημα με τους μονόδρομους υπερσυνδέσμους είναι ότι για έναν απλό χρήστη είναι πρακτικά αδύνατο να γνωρίζει την πηγή της πληροφορίας όταν ένας δημιουργός την διαθέτει οnline. Αυτό είχε σαν συνέπεια την έλευση ιδιωτικών εταιρειών με σκοπό τη μαζική παροχή αυτής της πληροφορίας και την εμφάνιση τεράστιου πλουτισμού σε ένα μιρκό ποσοστό της κοινωνίας, δλδ αυτούς τους μεσάζοντες, σε ένα αγαθό που θα μπορούσε εξ' αρχής αν είναι διαθέσιμο στο διαδίκτυο.
- Δεν απάντησα

### 9ο Bίντεο-κουίζ
- Μέσω του github συμμετειχαμε σε ομαδικά projets και μέσω των συζητήσεων και των issues είχαμε ανταλλαγή απόψεων και συνεργασία.
- Ναι αλλά ταυτόχρονα αποτέλεσαν και το έναυσμα για την αναζήτηση καινούργιων ιδεών.
- Πιθανότατα αναφέρεται στη Microsoft. Οι πολλές γραμμές γραμμές κώδικα σημαίνει ότι είναι δυσκολο να ελεγχθεί ή να τροποποιηθεί. Επίσης, χρειάζεται πάρα πολλούς προγραμματιστές, γεγονός που δυσχεραίνει ακομή περισσοτερο την κατάσταση επειδή θα πρέπει να λειτουργούν συντεταγμένα και εναρμονισμένα.
- Δεν απάντησα
- Δεν απάντησα
- Οι συμβουλές του Alan Kay στο μάθημα εφαρμόζονται με την επιμονή στη χρήση της γραμμής εντολών σε έναν κόσμο που επικρατεί η εικόνα, κινούμενη και μη, δείχνοντας την αξιοπιστία του παλιού έναντι του καινούργιου. 

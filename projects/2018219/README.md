...
### 9ο Bίντεο-κουίζ
- Σε αυτό το μάθημα δεν συνεργάστηκα ιδιαίτερα μέσω του github με άλλους αλλά σε άλλο μάθημα χρησιμοποίησα το roadmap της επιλογής project για τη δημιουργία kanban board και το αυτοματο άνοιγμα και κλείσιμο των issues για το συγχρονισμό των ενεργειών της ομάδας. Επίσης τα git hooks στον έλεγχο και την ομογενοποίηση του κώδικα που γράφουν τα διάφορα μέλη της ομάδας

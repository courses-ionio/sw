...
Σκοπός της άσκησης είναι να απεικονίσουμε την απόδοση εκτέλεσης κάποιων  python scripts που έχουμε επιλέξει.
...
* [x] Εκτέλεση 5 κύκλων warmup πριν την συγκριτική αξιολόγηση(benchmarking)

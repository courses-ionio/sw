...
<h2><span id="Συμμετοχικό περιεχόμενο A1&A2">Συμμετοχικό περιεχόμενο Α1&Α2</span></h2>
 ...
 <h2><span id="Βιογραφικό 2o">Βιογραφικό 2o</span></h2>
  ...
  <h2><span id="Συμμετοχικό περιεχόμενο Β1&Β2">Συμμετοχικό περιεχόμενο Β1&Β2</span></h2>
   ...
   <h2><span id="Τελική Αναφορά-Συμπεράσματα">Τελική Αναφορά-Συμπεράσματα</span></h2>
       Φτάνοντας στο τέλος του εξαμήνου και ολοκληρώνοντας την αναφορά της εργασίας μου, θα ήθελα να αναφέρω τις γνώσεις και τις εμπειρίες που αποκόμισα από το συγκεκριμένο μάθημα. Όπως είχα αναφέρει και στους στόχους μου, η τεχνολογία λογισμικού κατάφερε να με εξοπλίσει με τις κατάλληλες δεξιότητες πάνω στα λειτουργικά συστήματα. Ειδικότερα έκανα χρήση του συστήματος Void Linux, ένα σύστημα χωρίς systemd και τελείως άγνωστο σε εμένα, με το οποίο κατόρθωσα να φέρω εις πέρας ασκήσεις γραμμής εντολών που ζητήθηκαν. Επιπλεόν, μέσα από τα εβδομαδιαία κουίζ (επιτεύχθηκαν 9/12) κατανόησα καλύτερα τον τρόπο με τον οποίο δουλεύουν τα λειτουργικά συστήματα και τον πραγματικό αντίκτυπο που έχουν στην καθημερινή, κοινωνική ζωή. Όσον αφορά την ομαδικότητα εν μέρει επιτεύχθηκε, καθώς υπήρχε επικοινωνία με τους συμφοιτητές μου μέσω των issues, με τον σχολιασμό παραδοτέων. Ωστόσο, στο κομμάτι της ομάδας μου υπήρχαν αρκετά προβλήματα, κάτι το οποίο δεν μας βοήθησε ιδιαίτερα. Αποτελεί όμως μια καλή ευκαιρία για την μελλοντική βελτίωση των ομάδικών οργανώσεων.  

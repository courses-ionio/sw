...
* `ntfy -b telegram send "Gathering information about network speed"` ενημερώνοντας τον χρήστη στο telegram ότι βρίσκεται εν λειτουργία μια διεργασία.
  
* `ntfy -b telegram send "Please be patient" έπειδη η διεργασία βρισκέται ακόμα σε λειτουργία
  
* `speedtest-cli --simple | while read speed_info; do notify-send "$speed_info"; done` 

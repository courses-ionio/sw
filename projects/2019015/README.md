...
| 2 | [Bιογραφικό και δημιουργία ομάδας](#βιογραφικό)| |
...
Για το βιογραφικό μου χρησιμοποίησα ως tamplate [αυτό](https://github.com/sharu725/online-cv) και το τροποποίησα ώστε να φαίνονται τα δικά μου στοιχεία.

...
| 10 | [Συμμετοχικό περιεχόμενο B1+B2](#Συμμετοχικο-2-με-αλλαγες-στο-συμμετοχικο-1)| | Δεν μπορεσα να σκεφτω καποιο περιεχομενο να διαλεξω για το case study και τη βιογραφια οποτε ασχοληθηκα με τη βελτιωση του Συμμετοχικου 1. Το προβλημα δεν ηταν το πως θα κανω την ασκηση (απλη χρηση του vim) αλλα να βρω ιδεες για να ερευνησω.|

...
| 2 | [βιογραφικό και δημιουργία ομάδας](#Ιστοσελίδα-βιογραφικού-και-ένταξη-σε-ομάδα) | https://github.com/courses-ionio/help/discussions/230 | Ακολούθησα τα κριτήρια για την άριστη βαθμολόγηση.|
...
| 5 | [Συμμετοχικό περιεχόμενο A1+A2](#Συμμετοχικο-1) | https://github.com/courses-ionio/help/discussions/428 | Ακολούθησα τις οδηγίες, πηρα greenlight και καναμε merge την προταση μου με επιτυχια. |
...
| 11 | [Άσκηση γραμμής εντολών](#Ασκηση-Γραμμης-Εντολων-4) | | Απο τις ασκησεις ειχε μεινει μονο το twilio να δοκιμασω, αλλα ηθελε τον αριθμο τηλεφωνου μου, οποτε δεν το εκανα. |

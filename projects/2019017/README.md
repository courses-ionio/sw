...
| 9 | [Άσκηση γραμμής εντολών](#Ασκηση-Γραμμης-Εντολων-3) | | Υπηρχε προβλημα με το py-spy (unsupported python version) και το hyperfine (δεν κατεβαινε). Εφοσον δεν την τελειωσα, αποφασισα να μην την βαλω στο show & tell (because I have nothing to show). |

...
| 10 | [Συμμετοχικό περιεχόμενο B1+B2](#Συμμετοχικο-2-με-αλλαγες-στο-συμμετοχικο-1)| | Ασχοληθηκα με τη βελτιωση του Συμμετοχικου 1 και για το συμμετοχικο 2 εκανα βιογραφία πανω στον Ken Thompson, πατερα του Unix.|

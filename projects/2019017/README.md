...
| 6 | [Άσκηση γραμμής εντολών 2](#Ασκηση-Γραμμης-Εντολων-2) | | Εκανα εγκατασταση το void linux σε VM απο iso image. Ηταν σχετικα ευκολη διαδικασια, αλλα κολλαει αρκετα στο τερμιναλ οποτε η εμπειρια εκει ηταν κουραστικη. |
| 7 | βιογραφικό | | |

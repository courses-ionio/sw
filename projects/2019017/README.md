...
| 9 | [Άσκηση γραμμής εντολών](#Ασκηση-Γραμμης-Εντολων-3) | | Ελεγξα το performance δυο python scripts μου στο Void λειτουργικο μου και κατεγραψα την αποδοση ωστε να βελτιωσω τον κωδικα τους. |
...
## Εισαγωγή
Το ενδιαφερον μου ειναι για bug testing και να κάνω όσο πιο μινιμαλιστικο γίνεται ένα πρόγραμμα ενώ είναι ταυτόχρονα efficient. Για αρχη εβαλα το ntfy να με ειδοποιει οταν το τερματικο στο λινουξ μου τρεχει μια εντολη. Για κάθε εντολή η οποία διαρκεί παραπάνω από 10 δευτερόλεπτα, όταν τελειώσει, θα μου πετάξει μια ειδοποίηση στο desktop για το πόσο διήρκησε. Για παραδειγμα να τρεξω ενα σκριπτακι για να δω τον χρονο που παιρνει να εμφανισει αποτελεσμα. Προχωρωντας, οταν ηρθε η ωρα να διαλεξω ενα λειτουργικο χωρις systemd, επελεξα το Void Linux OS, καθως διαβασα οτι υποσχοταν γρηγορο boot. Αποφασισα να ερευνησω αυτο το εξαμηνο λειτουργικα χωρις systemd ως το init τους, για να δω ποση μεγαλη διαφορα εχουν απο το systemd σε performance. Μετα απο καποιες προσπαθειες εγκαταστασης διαφορων λειτουργικων (π.χ. kiss linux) και χρησης αλλων (π.χ. BSD), κατεληξα στο Void. Συγκεκριμενα, το διαλεξα για το init του Void, το runit, που μπορει να δουλεψει *και* ως init, αλλα *και* ως διαχειριστης υπηρεσιων το οποιο αφηνει να δουλεψει αρμονικα μαζι με αλλες init διεργασιες (περισσοτερα στο συνδεσμο της ιστοσελιδας στην αντιστοιχη ενοτητα παρακατω). Σε μια ασκηση γραμμης εντολων εκανα performance monitoring ενος python script που ειχα απο παλια (κρυπτογραφηση συμμετρικου κλειδιου και αποστολη του).

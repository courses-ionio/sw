...
Τελειώνοντας το μάθημα Τεχνολογία λογισμικού αποκόμησα γνώσεις πάνω στα λογιμικά, τα συστήματα linux, τι είναι το UNIX, τι είναι το systemd, τι είναι το SySvInit. Ακόμη, πιστεύω πως κατάφερα μέσω της πλατφόρμας του Github να έρθω σε επαφή με πάρα πολλά λογισμικά και να εξετάσω τους πηγαίους κώδικες τους ώστε να εμπνευστώ και εγώ σε επόμενο επίπεδο από τα δικά τους έργα. Επιπλέον κατάφερα να χτύσω ένα σύστημα προσαρμοσμένο στις δικές μου ανάγκες χρησιμοποιώντας τόσο τους package manager της κάθε διανομής, όσο και άλλα repositories μέσω του git(π.χ. bashblog). Επιπρόσθετα μέσω τον ασκήσεων του συμμετοχικού περιεχομένου μελέτησα ένα προϊόν της Apple καθώς και την ζωή ενός από τους ιδρυτές της, Steve Jobs. Επίσης έμαθα πως το iOS και το MacOS βασίζεται πάνω στα UNIX που είναι η βάση πολλών συστημάτων σε συνδιασμό με το παράδειγμα της Apple, κατάλαβα πως μπορείς να χτήσεις ένα ικανοποιητικό σύστημα εξατομικευμένο στις δικές σου ανάγκες ανάπτυξης λογσμικού που δεν έχει να ζηλέψει τίποτα από πληρωμένο λογισμικό. Εκείνο ήταν το σημείο που συνδειτοποιήσα έμπρακτα την διαφορά του προϊόντος από την τεχνολογία. Τέλος το μάθημα μου έδωσε κίνητρο να αρχήσω να συμμετέχω ενεργά και εγώ στην ανάπτυξη του λογισμικού και των συστημάτων και να μην είμαι απλά ένας δέκτης αυτού του φαινομένου.

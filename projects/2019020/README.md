...
Για το δεύτερο παραδοτέο υλοποιήθηκε το [btc_price.sh](https://github.com/alkarvounis/iminlovewithbtc-/blob/main/btc_price.sh) το οποίο με ειδοποιεί όταν η τιμή του κρυπτονομίσματος Bitcoin (BTC) πέσει κάτω από 15,000 ευρώ.
[![asciicast](https://asciinema.org/a/KsHD1uEVA5VMOenJNc8XHWjn8.png)](https://asciinema.org/a/KsHD1uEVA5VMOenJNc8XHWjn8)
Για τις ανάγκες του τεστ αλλάζω την συνθήκη και λαμβάνω μια ειδοποιήση εάν η τιμή του BTC είναι μεγαλύτερη των 15.000 ευρώ πράγμα που ισχύει με τα σημερινά δεδομένα.

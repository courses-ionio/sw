...
Όσον αφορά τα δομικά υλικά, το Arch Linux αποτελείται κυρίως από πακέτα λογισμικού ελεύθερου και ανοιχτού κώδικα, με μεγάλη έμφαση στα ελαφριά και αποτελεσματικά εργαλεία. Μερικά από τα βασικά δομικά στοιχεία του Arch Linux περιλαμβάνουν το Pacman Pacman Manager, το οποίο χρησιμοποιείται για την εγκατάσταση και διαχείριση πακέτων λογισμικού, και το Arch Build System (ABS), το οποίο παρέχει μια συλλογή σεναρίων και εργαλείων για τη δημιουργία και την προσαρμογή πακέτων από τον πηγαίο κώδικα .

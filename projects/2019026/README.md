...
Η άσκησησ παραδόθηκε εκτός προθεσμίας λόγω προσωπικών/επαγγελματικών υποχρεώσεων. Η άσκηση που έκανα ήταν η συμμετοχή στην ομαδική συνομιλία weechat. Σε συνεργασία με τον αρχηγό της ομάδας Παναγιώτη Βαμβακά, δείξαμε πως μπορεί να πραγματοποιηθεί η συνομιλία στο weechat, καθώς και πως να γίνει σύνδεση και αποσύνδεση από αυτή.

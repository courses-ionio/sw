...
| 3 | Αίτημα ενσωμάτωσης στην ιστοσελίδα | [Συζήτηση](https://github.com/courses-ionio/help/discussions/353) [Link στην ιστοσελίδα του τμήματος](https://p19zing-sitegr.netlify.app/posts/) | Αρχικό Issue εντός προθεσμίας (Αίτημα ενσωμάτωσης έγινε δεκτό) |
...
| 5 | Συμμετοχικό περιεχόμενο A1+A2 |[Συζήτηση](https://github.com/courses-ionio/help/discussions/450) [Link στην ιστοσελίδα του βιβλίου](https://hungry-villani-11b334.netlify.app//timeline/consoles/) | Εντός προθεσμίας το Α1 και το Timeline |

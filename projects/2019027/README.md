...
| 12 | [Τελική αναφορά](#τελική-αναφορά) | | Εντός προθεσμίας |
...
πολύ περισσότερα για το git/github και το linux σε σχέση με αυτά που ήξερα. Όμως έχω αντιληφθεί ότι υπάρχουν 
σημαντικότερες ιδέες από την απλή χρήση των εργαλείων. Η βασικότερη ίσως είναι ότι για οποιοδήποτε τμήμα λογισμικού

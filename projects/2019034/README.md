...
<p/>
<br><br>Τέλος, έκανα live demo site ώστε να δω πως φαίνεται η αλλαγή που έκανα και αν όλα λειτουργούν σωστά. Αφού έγινε ο έλεγχος για τυχόν λάθη, έκανα το **pull request** μου μέσα στο *all_collections*, μου σχολίασαν οι δύο αξιολογητές που επέλεξα και έγινε το **merge** του.

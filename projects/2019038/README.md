...
Επίσης η πραγματοποιήση αυτής της άσκησης έγινε αφότου εγκατέστησα σε εικονική μηχανή VMware Workstation το λειτουργικό σύστημα Free-BSD. Παρακάτω φαίνεται η εκτέλεση της εντολής neofetch σε Free-BSD και το αποτέλεσμά της. <br>

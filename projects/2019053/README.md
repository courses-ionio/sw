...
&nbsp;&nbsp;&nbsp;&nbsp;Τα γραφήματα που παρουσιάζονται παραπάνω δημιουργήθηκαν κατά τη διάρκεια εκτελέσης των εντολών του asciinema recording. Θα ήθελα να προσθέσω πως πρίν τη καταγραφή αυτή είχα δοκιμάσει τις εντολές αυτές και τα flame graphs εμφανίστηκαν πολύ πιο απλοϊκά. Αυτό είχε ως αποτέλεσμα το speedscope να βγεί πολύ πιο **βοηθητικό** όπως μπορεί να φανεί και [εδώ](https://user-images.githubusercontent.com/72695605/168591410-4028b99f-7ce4-430c-948d-a5764f2330a1.PNG).

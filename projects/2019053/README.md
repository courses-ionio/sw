...
&nbsp;&nbsp;&nbsp;&nbsp;Πέρα από όλα αυτά όμως θα ήθελα να εστιάσω στα [video quiz](https://courses-ionio.github.io/help/quiz/). Τα **quiz** έχουν στόχο την ενημέρωσή μας για πολύ σημαντικούς πληροφορικούς και την ιδεολογία τους πάνω στον κλάδο. Μας θέτουν βασικά ερωτήματα τα οποία συζητάμε στα δια ζώσης ραντεβού και μέσα από αυτές τις συζητήσεις ερχομάστε όλο και ένα βήμα πιο κοντά στην προσωπική μας ανάπτυξη. Σε ποικίλα θέματα θεωρώ πως έχει αναπτυχθεί η κρίση μου αφού συνειδητοποίησα πως το γεγονός ότι κάτι είναι δημοφιλές δε σημαίνει πως είναι και καλό. Για παράδειγμα τα πασίγνωστα windows έχουν ένα πολύ κακογραμμένο κώδικα όπου μπορούν να συμβούν αναπάντεχα errors και ένα άλλο πρόβλημα είναι πως με το κατέβασμα ενός πακέτου κατεβαίνουν και άλλα επιπρόσθετα χωρίς την έγκριση του χρήστη. Σε αντίθεση με αυτήν την αρχιτεκτονική, το βασικό στοιχείο για την ομαλή λειτουργία ενός λειτουργικού συστήματος που επαναλαμβάνεται στα βίντεο quiz είναι η **ανάγκη για απλότητα** και η δυνατότητα για **ελεύθερη χρήση**. Επίσης μου έκανε πολύ θετική εντύπωση το λογισμικό **Etoys** το οποίο έχει ως επίκεντρο την συμφιλίωση των παιδιών με τον κλάδο της Πληροφορικής. Σε εκείνο το βίντεο ο Άλαν Κέυ έδειξε πως τα παιδιά μέσω της χρήσης απλών εντολών μπορούν να καθοδηγήσουν ένα ψηφιακό αμάξι, με αυτόν τον τρόπο υπάρχει διαδραστικότητα και τα παιδιά ενθουσιάζονται με το αντικείμενο. Τέλος, θα ήθελα να προσθέσω



Για παράδειγμα θέματα όπως κατά πόσο η εκπαίδευση επιτυγχάνεται σωστά στα πανεπιστήμια, αν ο προγραμματισμός θα πρέπει να είναι σύνθετος ή όχι, αν τα παιδιά θα πρέπει να εκπαιδεύονται στον κλάδο αυτό και πολλά άλλα σημαντικά ζητήματα μας δίνουν γνώσεις που ενώ στον επαγγελματικό τομέα μπορεί να μην είναι ιδιαίτερα χρήσιμες, είναι όμως πολύ χρήσιμες στην **φιλοσοφία** μας.

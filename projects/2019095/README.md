...
# Systemd & PQ - ΠΑΡΑΔΟΤΕΟ 2
  ...
  Σε αυτό το παραδοτέο χρησιμοποίησα το [ntfy](https://ntfy.sh/) για να στείλω notification στο κινητό μου μέσο ενός python προγράμματος. Επέλεξα αυτήν την άσκηση καθώς θεωρώ ότι είναι ένα ιδιέτερα χρηστικό εργαλείο ιδικά για μεγάλα tasks τα οποία μπορεί να χρειαστούν ώρες για να ολοκληροθούν. Χρησιμοποιόντας το ntfy μπορώ να ελένχω τα δίαφορα output/checkpoints όπου έχω ορίσει στο task χωρίς να χρειάζεται να είμαι πάνω από τον υπολογιστή.

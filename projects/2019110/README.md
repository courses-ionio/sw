...
| 10 | **[Συμμετοχικό περιεχόμενο B1+B2](#Συμμετοχικό-περιεχόμενο-Β)** | [Ανακοίνωση στο help για συμμετοχικό Β | Τα θέματα που επέλεξα θεωρώ ότι είναι αρκετά καλά, αλλά οι πληροφορίες που σύλλεξα και τα κείμενα που ανέπτυξα δεν με άφησαν πολύ ευχαριστημένο. Η διαδικασία με τα submodules και το netlify έχει πολύ σύντομα και εύκολα. |

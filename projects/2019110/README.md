...
| 12 | Τελική αναφορά* | | Έγιναν οι απαραίτητες προσθήκες όπως το τελικό συμπέρασμα και ολοκληρώθηκε η ιστοσελίδα του οργανισμού μαζί με όλα τα PR συμμετοχικού Α+Β με σωστό και λειτουργικό τρόπο. Ελέγχθηκε ολόκληρη η αναφορά μου για οτιδήποτε έχω ξεχάσει και ενημερώθηκαν οι εβδομαδιαίες παρουσίασεις των προόδων μου με τις τελικές αλλαγές. |

...
| 7 | **Bιογραφικό [Μέρος Β](#Μέρος-Β)** | [Ανάρτηση Β' μέρους βιογραφικού](https://github.com/courses-ionio/help/discussions/521) | |
...
Στο μάθημα <<Τεχνολογία λογισμικού>> ενδέχεται να εξελίξουμε τις δεξιότητες μας που αφορούν την πλατφόρμα του **Github** και το λειτουργικό σύστημα **Linux** που θα εργαστούμε, μέσω των εργασιών που θα υποβάλλουμε κάθε εβδομάδα ανάλογα με τον κόπο του καθενός. Σκοπός μου δεν είναι να εμβαθύνω πολύ σχετικά με τα λογισμικά, αφού για τα προτεινόμενα (linux from scratch, kiss linux, plan 9) πρέπει να θυσιαστεί υπερβολικός κόπος και χρόνος, ενώ στο τέλος να μην είμαι αρκετά ικανός να βγάλω εις πέρα τις δύο εργασίες software. Στην εισαγωγή γίνεται αναφορά για τη χρήση μη γνωστών και μη κυρίαρχων-εμπορικών συστημάτων που σημαίνει προσαρμογή σε νέα πιο ευέλικτα, αλλά ταυτόχρονα πιο δύσκολα στη χρήση τους λογισμικά όπως τα Linux alpine(το οποίο επιθυμώ να χρησιμοποιήσω), artix, absolute. Το νόημα βρίσκεται επίσης στον λόγο που θα κάνουμε τις αντίστοιχες επιλογές στις εργασίες και την συνεισφορά τους σε διάφορα επίπεδα της ζωής και της καθημερινότητας μας. 

Επιθυμώ να μπω σε σκέψεις σύμφωνα με τις διαφορετικές οπτικές που εξετάζουν ο Alan kay, Bret Victor, Ted Nelson την εξέλιξη των λογισμικών, την αρχιτεκτονική υπολογιστών, μέχρι και την εκπαίδευση, στις ανώτερες βαθμίδες κυρίως. Η διδασκαλία των 4 μαθημάτων(φυσική,μαθηματικά,μηχανική,πληροφορική) παρομοιάζονται ως τέχνη, διαφορετικά από το τρόπο που τα βλέπουμε εμείς και θα έπρεπε να εξετάζεται το πως επηρεάζουν τον πολιτισμό μας. Η έννοια του προγραμματισμού, να αμφισβητείται συνεχώς, μέσα από το μάθημα σκοπεύω με την επεξεργασία αρχείων με κείμενο να σκέφτομαι αν πράγματι είναι μέρος του, δεν είχε προβλεφθεί ότι θα "προγραμματίζουμε με τέτοιου είδους αρχεία". Έχω στόχο μέσα από τη χρήση των παλιών λογισμικών που έχουν περιθωριοποιηθεί από τα εμπορευματοποιημένα Windows, Ios, γιατί υποστηρίζονται τόσο από τον Alan Kay και αν μπορούν να προσφέρουν τις ίδιες βασικές δυνατότητες.

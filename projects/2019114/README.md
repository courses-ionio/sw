...
Για την πρώτη εβδομάδα που ασχοληθήκαμε με τις γραμμές εντολών αποφάσισα να εγκαταστίσω το Freebsd που είναι ένα λειτουργικό σύστημα χωρίς systemd το οποίο μπορείτε να δείτε στο αντίστοιχο [asciinema](https://asciinema.org/a/G4uKcF8vkRRzuZXpZu7k6A4Wq).

...
| 4 | [Άσκηση γραμμής εντολών](#Εγκατάσταση-λογισμικού ) |[link discussions](https://github.com/courses-ionio/help/discussions/380) |Εμπρόθεσμο παραδοτέο/Εγκατάσταση FreeBSD/ λογισμικό χωρίς systemd/ ρύθμισή του και χρήση asciinema 6.5/10.|
...
| 7 | [βιογραφικό](#Βιογραφικό-και-ομάδα) |[link discussions](https://github.com/courses-ionio/help/discussions/705) |Μη εμπρόθεσμο παραδοτέο/ Δημιουργία μη αυτόματου βιογραφικού με pandoc και latex/ δημιουργία αυτόματου βιογραφικού με GitHub Actions 5/10 |

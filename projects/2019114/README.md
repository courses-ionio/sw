...
| 9 | [Άσκηση γραμμής εντολών](#8ο-Παραδοτέο-Άσκηση-γραμμής-εντολών) |[link discussions](https://github.com/courses-ionio/help/discussions/706) | |
| 10 | [συμμετοχικό περιεχόμενο B1+B2](#10ο-Παραδοτέο-Συμμετοχικό-περιεχόμενο-Β1-και-Β2) | |Δεν έγινε εμπρόθεσμα το pull request στην ομάδα/ δημιουργία βιογραφίας και μελέτη περίπτωσης/ δημιουργία demo site/ επιτυχή προσθήκη τους στην ιστοσελίδα του οργανισμού έπειτα από pull request 7.5/10 |

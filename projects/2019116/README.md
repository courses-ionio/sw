...
Με αφορμή την εργασία αυτή, πιστεύω πως κατάφερα να αποκτήσω περισσότερες γνώσεις πάνω στο GitHub, στο λειτουργικό σύστημα Linux(ειδικότερα στο Devuan το οποίο δεν κάνει χρήση του υποσυστήματος systemd) και στην τεχνολογία του Docker. Κάτι το οποίο θα μου μείνει από τα διάφορα video quiz που είδαμε είναι το πως φτάσαμε στην πρώτη C έκδοση του λειτουργικού συστήματος UNIX, δηλαδή πως από την B, την B virtual και την nB, φτάσαμε στην C και μετά στην πρώτη C έκδοση του λειτουργικού συστήματος UNIX.

...
- Έπειτα, παρατήρησα ότι ίσως όλες οι ιδέες που μπορεί να είχα να είναι ήδη issues που δεν έχουν λυθεί ακόμα [αλλά δυστηχώς δε μπορούσα να τις λύσω επειδή δεν είχε αναφέρει κανένας ότι έχει σταματήσει να δουλεύουν πάνω σε αυτά τα issues](https://github.com/ioniodi/sitegr/issues/272#issuecomment-1094362662).

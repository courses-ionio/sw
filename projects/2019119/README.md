...
- Μάθω τους λόγους τους οποίους έδωσαν έναυσμα σε μεγάλους πατέρες της πληροφορικής να δημιουργήσουν λογισμικά και τεχνολογίες που χρησιμοποιούνται μέχρι σήμερα.

...
| 9 | [Άσκηση γραμμής εντολών](#παραδοτέο-9) |[Discussions](https://github.com/courses-ionio/help/discussions/667) |Για την άσκηση γραμμής εντολών εγκατέστησα το hyperfine και σύγκρινα δύο python scripts που δημιούργησα.|

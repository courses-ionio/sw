...
| 5 | [Συμμετοχικό περιεχόμενο A1+A2](#παραδοτέο-5) |[Discussions](https://github.com/courses-ionio/help/discussions/564) |Για το 5o παραδοτέο, αποφάσισα να προσθέσω 2 εικόνες και λεζάντες για το λειτουργικό Archbang και το Austrumi κάτι το οποίο θεωρώ ότι ταιριάζει με το θέμα του μαθήματος. Επίσης, προσέθεσα σε ήδη υπάρχοντα timeline και slides, διότι υπήρχαν απο πριν. Τέλος, άνοιξα αίτημα ενσωμάτωσης και περάστηκαν στο site της ομάδας μου. |

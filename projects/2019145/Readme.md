...
Ακόμα δεν έχω καταφέρει να ολοκλήρωσω αυτό το παραδοτέο καθώς τα προβλήματα επικρατούν. Θα συνεχίσω τις προσπάθειές μου μέχρι κοντά το τέλος του παραδοτέου 6, και αν δεν έχω καταφέρει σημαντική προόδο μάλλονν θα κινηθώ προς BSD σύστημα. Επιπλέον, θα αναρτήσω μερικές φωτογραφίες δείχνωντας τα προβλήματα από την προηγούμενη φορά.

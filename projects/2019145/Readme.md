...
Ενδεικτικά για την δομή της αναφοράς, καθώς ήθελα να δείξω μία πιο ξεκάθαρη διαφορά μεταξύ την αρχή των παραδοτέων αλλά και το πως προχώρησα και τι άλλαξα χωρίς να είναι ανάγκη να περάσει κάποιος από πάρα πολλά commits, αποφάσισα να τοποθετήσω αυτές τις προσθήκες ως "updates", στα οποία αναφέρω αυτές τις προσθηκές. Ώσο αφορά τα link των εβδομαδιαίων παρουσιάσεων στο GitHub, για τις βδομάδες 9 και 11 δεν υπάρχουν link καθώς παρεδ
<br>
</br>
<br>
</br>

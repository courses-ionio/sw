...
| 2 | Γραμμή εντολών (systemd) και διαδικασία συνεργασίας με pull request στον οργανισμό της ομάδας μου | Link στο Discussions | Αυτή την εβδομάδα έκανα το 2ο παραδοτέο χρησιμοποιόντας λειτουργικό σύστημα Arch Linux 2023.03. 01 x86_64 |

...
<h3> Το δεύτερο παραδοτέο, είναι η δημιουργία βιογραφικού και η δημιουργία ομάδας. 
  ...
  Για την περίπτωση του βιογραφκού, καλούμαστε να επιλέξουμε ένα template, και να το ολοκληρώσουμε με τα στοιχεία που επιθυμούμε. Έτσι κάνοντας folk το `online-cv`

...
<h3> Δυστηχώς, δεν κατάφερα να ολοκληρώσω το 8ο παραδοτέο παρ'όλα αυτά, θα ήθελα να μοιραστώ την ιδέα μου, για οποιονδήποτε θέλει να την υλοποιήσει. Θα ήταν μία καλή προσθήκη στην ιστοκελίδα του πανεπηστημίου η πρόσθεση dark theme. Δηλαδή, μία επιλογή για του χρήστες δηλαδή να έχουν μαύρο το background και λευκά τα γράμματα έτσι ώστε η περιήγηση στον ιστότοπο να γίνεται με πιο ξεκούραστα μάτια. 

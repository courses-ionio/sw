...
| 7 | Συμμετοχικό περιεχόμενο B1 | [Link στο Discussions](https://github.com/courses-ionio/sw/discussions?discussions_q=is%3Aopen+%CE%A02019150) | Για την έβδομη εβδομάδα, δημιούργησα ένα νέο brach στο forked site από την ομάδα μου με όνομα paradoteo-7. Σε αυτό έκανα τις απαραίτητες προσθήκες και κατάφερα να εμφανήσω τα αποτελεσματά μου. Ως case study επέλεξα το OpenAI API. |

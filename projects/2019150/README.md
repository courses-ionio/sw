...
<h3> Ως άσκηση της 4ης εβδομάδας επέλεξα την εγκατάσταση του freebsd. Αυτή η επιλογή έγινε, κυρίος γιατί υπάρχει πολύ υλικό πάνω σε διεργασίες που μπορούν να γίνουν σε αυτό το λογισμικό. 
  ...
  Για την εγκατάσταση χρειάσηκαν 4 πράγματα: 
       ...
       (3) Το VMware και η εγκατάσταση του Freebsd σε αυτό: Η εγκατάσταση ενός λογισμικού στο VMware ήταν ένα αρκετά απλό task, καθώς καλούμαστε διαρκός να πειραματιστούμε και να εργαστούμε με νέα λογισμικα, για το οποία βέλτιστη λύση είναι η εγκατάσταση τους σε κάποιο virtual machine.

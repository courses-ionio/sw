...
| 3 | Γραμμή εντολών (no systemd) | [My link](https://github.com/courses-ionio/sw/discussions/1316)| Πραγματοποιήθηκε 100%, στο συγκεκριμένο παραδοτέο εγκατέστησα το Alpine linux, που είναι no systemd και ήταν η πρώτη μου επαφή, στην αρχή δυσκολεύτηκα λίγο αλλά πλέον γνωρίζω τη διαδικασία. |

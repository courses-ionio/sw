...
Η εικόνα που σχετίζεται με το βιντεοπαιχνίδι απεικονίζει το παιχνίδι Assassin's Creed Odyssey και βρίσκεται [εδώ](). 

Η εικόνα για τη γλώσσα προγραμματισμού δείχνει έναν κώδικα σε java και βρίσκεται [εδώ]().

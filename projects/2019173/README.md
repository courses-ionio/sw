...
Η εικόνα που σχετίζεται με το βιντεοπαιχνίδι απεικονίζει το παιχνίδι Super Mario και βρίσκεται [εδώ](). 

Η εικόνα για τη γλώσσα προγραμματισμού δείχνει έναν κώδικα σε python και βρίσκεται [εδώ]().
...
Για το βιντεοπαιχνίδι: [στο σετ με τις διαφάνειες βρίσκεται εδώ](https://p19pasa.netlify.app//slides/videogames/) και [στο χρονολόγιο αυτό βρίσκεται στο έτος 1981](https://p19pasa.netlify.app//timeline/videogames/).

...
Στο δεύτερο παραδοτέο ζητήθηκε να δημιουργήσουμε ομάδες και να κάνει το κάθε μέλος το βιογραφικό του. Έτσι, αφού διαλέξαμε την ομάδα μας έγινε το webring μας και στη συνέχεια διάλεξα ένα από τα προτεινόμενα βιογραφικά που δίνονται στις οδηγίες και ολοκλήρωσα και το βιογραφικό μου. Παρακάτω θα βρείτε τα αντίστοιχα link. 

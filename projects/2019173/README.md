...
- 2) Οι φωτογραφίες που έχω στην αναφορά μου θα πρέπει να έχουν σχέση με την διαδικασία των παραδοτέων και όχι να είναι απλά να είναι σαν μία φωτογραφία, όπως για παράδειγμα, οι φωτογραφίες που επέλεξα για το 5ο παραδοτέο. 

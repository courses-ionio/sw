...
Στην ιστοσελίδα, πάνω στην οποία έχουμε αυτό το παραδοτέο, θα μπορούσε να διαμορφωθεί καλύτερα η επεξήγηση που δίνεται στις σπουδές. Για παράδειγμα, θα μπορούσε κάτω από κάθε μάθημα, εκτός από την διδακτική ύλη, να αναφέρεται και ο καθηγητής που θα διδάσκει το μάθημα. Επίσης, θα μπορούσαν να αναγράφονται οι λόγοι που είναι σημαντική η εκμάθηση του κάθε μαθήματος, καθώς και η εκμάθησή του στο συγκεκριμένο έτος.

...
- 1ο: Αναφορά στις ανάγκες και τους στόχους του φοιτητή και στις προσδοκίες του μαθήματος.  
- 2ο: Άσκηση προγραμματισμού: [Mouse Form](https://pibook.epidro.me/remix/mouse-form/).   
- 3ο: Άσκηση γραμμής εντολών: [get familiar with basic commands, reading documentation and editing files](https://github.com/p19pasa/dokey/blob/master/README.md). 
- 4ο: Άσκηση προγραμματισμού: [Menu pie](https://pibook.epidro.me/remix/menu-pie/).  
- 5ο: Άσκηση γραμμής εντολών: [become productive with a todo list](https://github.com/epidrome/dokey). 
- 6ο: Συμμετοχικό περιεχόμενο: Α1) δύο εικόνες με λεζάντες, που συνδέονται με το μάθημα και Α2) σετ διαφανειών και χρονολόγιο που σχετίζονται με τις εικόνες.
- 7ο: Άσκηση προγραμματισμού: [Image zoom](https://pibook.epidro.me/remix/image-zoom/). 
- 8ο: Άσκηση γραμμής εντολών: [add a status bar to your shell/editor and configure a color-theme](https://github.com/epidrome/dokey#hci). 
- 9ο: Άσκηση προγραμματισμού: [Sortable list](https://pibook.epidro.me/remix/sortable-list/). 
- 10ο: Άσκηση γραμμής εντολών: [text editor and plug-ins for code highlighting and autocompletion](https://github.com/epidrome/dokey#hci). 
- 11ο: Συμμετοχικό περιεχόμενο: Β1) μια νέα μελέτη περίπτωσης και Β2) μια νέα βιογραφία. 

...
Για τη βιογραφία:
Η COMSOL, Inc ιδρύθηκε το 1986, στη Στοκχόλμη, Σουηδία και είχε γονικό οργανισμό την COMSOL AB. Παρέχει έναν αριθμό έτοιμων προς χρήση τρόπων εφαρμογής εντός των πεδίων της μηχανικής και της επιστήμης. Η εταιρεία αυτή καλύπτει με τις λειτουργίες που προσφέρει τα Ηλεκτρομαγνητικά AC και DC, την Ηλεκτροστατική και τη μαγνητοστατική, τη Διάδοση κυμάτων σε επίπεδο, την Ισοζύγια θερμότητας και μάζας σε συνδυασμό με την κινητική αντίδρασης, την Μηχανική ρευστών, καθώς και την Δισδιάστατη και τρισδιάστατη δομική μηχανική και αναλύσεις.

...
| 11 | [Άσκηση γραμμής εντολών](https://github.com/p19pasa/sw/blob/2019173/projects/2019173/README.md#%CE%AC%CF%83%CE%BA%CE%B7%CF%83%CE%B7-%CE%B3%CF%81%CE%B1%CE%BC%CE%BC%CE%AE%CF%82-%CE%B5%CE%BD%CF%84%CE%BF%CE%BB%CF%8E%CE%BD-11%CE%BF-%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%B5%CF%8C) | | |
...
Σε αυτό το παραδοτέο μας ζητήθηκε να κάνουμε μία άσκηση γραμμής εντολών. Επέλεξα να κάνω την άσκηση γραμμής εντολών send notifications to your desktop-mobile από τις ασκήσεις που υπάρχουν στο [software](https://github.com/epidrome/dokey#software). Στη συγκεκριμένη άσκηση έπρεπε μέσω της εντολής ntfy να στείλεις ενημερώσεις στο κινητό τηλέφωνό σου, όπως κάποια εγκατάσταση που έχει ολοκληρωθεί, κάποιο μήνυμα. Έτσι, εγώ μέσω του τερματικού του Void Linux κατάφερα να στείλω μηνύματα στην οθόνη του κινητού μου και ειδοποίηση ότι η εγκατάσταση μίας εφαρμοφής, της Zoom, ολοκληρώθηκε.
Ωστόσο, για να επιτευχθούν αυτά χρειάστηκε:
- να καταβάσω το ntfy στο τερματικό με την εντολή sudo pip install ntfy και
- να συνδέσω το desktop του κινητού μου με το τερματικό, ώστε να μπορεί να ενημερώνεται.


Παρακάτω είναι χρήσιμοι σύνδεσμοι:

[Εδώ]() είναι το link για το asciinema.

[Εδώ](https://github.com/dschep/ntfy) είναι το link της ιστοσελίδας που με βοήθησε.

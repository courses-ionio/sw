...
| --- | --- | --- | --- |
| 1 | [Εισαγωγή](#1ο-Παραδοτέο) | [Link](https://github.com/PeteSKK/sw/blob/2019196/projects/2019196/Readme.md#1%CE%BF-%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%AD%CE%BF) |Υπο τις οδηγίες του κύριου Χωριανόπουλου, επεκτάθηκα στο τι ήθελα να μάθω και κάποια πράγματα που μου τράβηξαν την προσοχή. Δυστυχώς δεν κατάλαβα όλες τις έννοιες που αναφέρθηκαν, αλλά έκανα τα δυνατά μου και προσπάθησα να απαντήσω ειλικρινά. |
...
| 5 | [Συμμετοχικό περιεχόμενο Talespire και Human fall flat](#Συμμετοχικό-περιεχόμενο-Talespire-και-Human-fall-flat) | |Βρήκα, έψαξα σε βάθος και έγραψα για ένα θέμα που θεώρησα καλό και αξιοπρεπές. Αλλά δεν κατάφερα να κάνω την ιστοσελίδα να δουλέψει, και έπειτα απο προσπάθειες απότυχα να λύσω το θέμα μου με τον συνάδελφο. Μαθήματα που πήρα για την ετοιμασία και οργάνωσης μιας ομάδας. 2 |
...
| 8 | [Αίτημα ενσωμάτωσης στην ιστοσελίδα 2](#Αίτημα-ενσωμάτωσης-στην-ιστοσελίδα-2) | |Έκανα την προσπάθεια μου. Έστειλα το αίτημα πριν την προθεσμία. Αλλά κατέντησε εκτός. Γνωρίζω όμως οτι ο κύριος Χωριανόπουλος θέλει τουλάχιστον να δει την προσπάθεια μας, αρα αν και δεν γνωρίζω πόσο σημαντική είναι η προσπάθεια εναντίον το αποτέλεσμα, δεν θα μου δώσω τίποτα. Μου δίνω 2 |

...
| 5 | [Συμμετοχικό περιεχόμενο Talespire και Human fall flat](#Συμμετοχικό-περιεχόμενο-Talespire-και-Human-fall-flat) | |Βρήκα, έψαξα σε βάθος και έγραψα για ένα θέμα που θεώρησα καλό και αξιοπρεπές. Επισής κατάφερα να το κάνω να δουλεύει κανονικά και καλά. 10 |
...
| 8 | [Αίτημα ενσωμάτωσης στην ιστοσελίδα 2](#Αίτημα-ενσωμάτωσης-στην-ιστοσελίδα-2) | |Μου πήρε ώρα να ψάχνω για να καταλάβω πως είναι οργανωμένη η ιστοσελίδα, αλλά στο τέλος... έγινε. Αλλά δεν είχε γίνει δεκτό το θέμα. 8 |

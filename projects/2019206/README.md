...
:exclamation: Πρέπει να αναφέρω ότι λόγω κάποιου προβλήματος, το kali δεν εμφανίζεται στο [χρονολόγιο]() του site της [ομάδας μας](https://github.com/ionioi). (Με τις [διαφάνειες](https://ionioi-site.netlify.app/slides/os/) δεν υπάρχει κανένα πρόβλημα.)

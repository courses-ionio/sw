...
| [10](#τελική-αναφορά---παραδοτέο-10) | Τελική αναφορά* | [Σύνδεσμος παρουσίασης προόδου εβδομάδας 10](https://github.com/courses-ionio/sw/discussions/1688)| Συγγραφή της τελικής μου αναφοράς όσον αφορά την επίτευξη των στόχων μου |
...
# Τελική Αναφορά - Παραδοτέο 10
Στο πλαίσιο του μαθήματος Τεχνολογίας Λογισμικού (SW), είχα  να εξοικειωθώ με διάφορα λειτουργικά συστήματα Unix, όπως τα **Arch Linux**, **Void Linux**, **Kiss Linux** καθώς και των διαφόρων συστημάτων εκκίνησης που πρόσφεραν άντι του `systemd`. Οι ασκήσεις εντολών και εγκατάσταση πακέτων όπως `bashblog` για την δημουργία της ιστοσελίδας μου, βοήθησαν στην ολοτελή γνώση του τερματικού περιβάλλον. 

Η συννεργασία μεταξύ της ομάδας μου [LetMeDoItForYou](https://github.com/LetMeDoItForYou/), μου έδωσε ένα εξαιτερικό εργαλείο στον τομέα της συννεργασίας, διατήρησης και οργάνωσης των αποθετηρίων μας, επιτρέποντας μας μια ομαλή και συννεργατικά δυνατή πρόοδο λόγω των εποικοδομητικών σχόλιων. Επιπλέον, στα συμμετοχικά περιεχόμενα μου δώθηκε η ευκαιρία να ερευνήσω και να γράψω για εξομοιωτές όπως το `DOSBox` και `SheepShaver` και στην συνέχεια του, να γράψω την βιογραφία του `Fred Brooks`, ενός εξαιρετικά σημαντικού προσώπου στον τομέα της εξομοίωσης. 

Συνολικά, θεωρώ ότι επιτέλεσα τους στόχους που είχα θέσει στην αρχή του μαθήματος και με το παραπάνω, και για αυτό τον λόγο αισθάνομαι πολύ πιο εξοπλισμένος σε σύγκριση με την αρχή του εξαμηνού όσον αφορά τις δεξιότητες και γνώσεις μου στον τομέα της Τεχνολογίας Λογισμικού.
...
Γενικότερα, ο κ. Βραχάτης βρήκε το `README.md` αρκετά περιγραφικό και οργανωμένο, όσον αφορά την έκταση κειμένο καθώς και της προσθήκης φωτογραφιών και στηλών για την προβολή των συνδέσμων στα συμμετοχικά A1/A2 και Netlify.

## Συνεισφοράς σε Αιτήματα Ενσωμάτωσης 
| Σύνδεσμος σχολίου σε αιτήμα ενσωμάτωσης |  Σύνδεσμος προφίλ συμφοιτητή/τριας | 
| --- | ---  |

...
Η συννεργασία μεταξύ της ομάδας μου (LetMeDoItForYou), μου έδωσε ένα εξαιτερικό εργαλείο στον τομέα της διατήρησης και οργάνωσεις των αποθετηρίων μας, επιτρέποντας μας μια ομαλή και συννεργατικά δυνατή πρόοδο λόγω των εποικοδομητικών σχόλιων. Επιπλέον, στα συμμετοχικά περιεχόμενα μου δώθηκε η ευκαιρία να ερευνήσω και να γράψω για εξομοιωτές όπως το `DOSBox` και `SheepShaver` και στην συνέχεια του, να γράψω την βιογραφία του `Fred Brooks` ενός εξαιρετικά σημαντικού προσώπου στον τομέα της εξομοίωσης. 

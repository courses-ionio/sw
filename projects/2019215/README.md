...
- Το [issue](https://github.com/ioniodi/sitegr/issues/253) του 1ου παραδοτέου για το αίτημα ενσωμάτωσης στη σελίδα. Σαν πρώτη αλλαγή πρόσθεσα στο προσωπικό του τμήματος τον νέο καθηγητή Αθανάσιο Τσίπη ως ακαδημαϊκό υπότροφο.

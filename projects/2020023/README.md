...
| [5](#συμμετοχικό-περιεχόμενο-α1+α2---5ο-παραδοτέο) | Συμμετοχικό περιεχόμενο A1 + A2 | [Discussions Link](https://github.com/courses-ionio/sw/discussions/1437) | Πιστέυω πως έχω καλύψει το ζητούμενο επιλέγοντας δύο ενδιαφέρουσες περιπτώσεις. |
...
**Διαφάνειες markdown**: [Εξομοίωση](https://github.com/p20samiv2/site/blob/master/_slides/emulation.md) 
...
**Διαφάνειες markdown**: [Εξομοίωση](https://github.com/TheTimeParadox/site/blob/master/_slides/emulation.md) / [Οπτικός προγραμματισμός](https://github.com/TheTimeParadox/site/blob/master/_slides/visual-programming.md)  

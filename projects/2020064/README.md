...
| 5 | [Συμμετοχικό περιεχόμενο A1 + A2](#5η-εβδομάδα) | [Σύνδεσμος στην εβδομαδιαία παρουσίαση]() | |
| 6 | [Γραμμή εντολών (no systemd, custom static blog generator)](#6η-εβδομάδα) | [Σύνδεσμος στην εβδομαδιαία παρουσίαση]() | |
| 7 | [Συμμετοχικό περιεχόμενο B1](#7η-εβδομάδα) | [Σύνδεσμος στην εβδομαδιαία παρουσίαση]() | |

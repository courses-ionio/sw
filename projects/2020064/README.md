...
| 3 | [Γραμμή εντολών(no systemd)](#3η-εβδομάδα) | | Αυτήν την εβδομάδα είμαι ευχαριστημένος καθώς προέβηκα επιτυχώς στην χειροποιήτη εγκατάσταση μιας νέας source-based διανομής, της οποίας η διαδικασία εγκατάστασης μου προσέφερε αρκετές σημαντικές γνώσεις και δεξιότητες.|
...
Επίσης, ένα ακόμα προτέρημα της διανομής είναι το αίσθημα ασφαλείας που έχει ο χρήστης ως προς τι ενσωματώνει στο μηχάνημά του, καθώς δεν του ζητάτε να εμπιστευτεί ένα τελικό εκτελέσιμο αρχείο το οποίο δεν γνωρίζει τι εμπεριέχει, καθώς έχει έυκολη πρόσβαση στον πηγαίο κώδικα κάθε πακέτου τον οποίο μπορεί να μελετήσει/τροποποιήσει εφόσον το επιθυμεί. 

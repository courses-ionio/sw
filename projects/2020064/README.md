...
| 4 | [Κατασκευή του βιβλίου Α2 (συνεργατικά)](#4η-εβδομάδα) | [Σύνδεσμος στην εβδομαδιαία παρουσίαση]() | Αν και κατάφερα να φέρω εις πέρας τα παραδοτέα αυτής της εβδομάδας, δεν είμαι απόλυτα ευχαριστημένος από τον εαυτό μου καθώς δεν έχω κατορθώσει ακόμα να συντονίσω το workflow του οργανισμού. |

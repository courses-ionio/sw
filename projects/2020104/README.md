...
Όταν συνδέθηκα στα ArchLinux έκανα εγκατάσταση κάποιον drivers έτσι ώστε να είναι εφικτή η σύνδεση του usb και σε άλλους υπολογιστές και τέλος έγινε η εγκατάσταση του asciinema και η σύνδεση με τον λογαριασμό μου σε αυτό. Τέλος εκτέλεσα την εντολή [neofetch](https://asciinema.org/a/gMlsZR64vqV7k9x7wH8hYuAno) για να δείξω από που το τρέχω και το py-spy όπου παίρνει samples και φτιάχνει ένα frame graph του προγράμματος.

...
### Ομάδα
Όσο για το συμμετοχικό κομμάτι η ομάδα μου ήταν άψογη. Όχι μόνο μπορούσαμε να συννενοηθούμε σε έναν αρκετά καλό βαθμό αλλά βοηθούσαμε ο ένας τον αλλόν να ξεπεράσει προβλήματα τα οποία μπορεί να είχαμε. Με βοήθησε πάρα πολύ να αναπτύξω την ομαδικότητα μου και να μπορώ να δουλεύω ως μέλος μίας ομάδας.

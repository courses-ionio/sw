...
### Netlify
Μου δόθηκε και η ευκαιρία να γνωρίσω ένα site όπως το Netlify. Μπορώ να πω ότι δεν ήξερα την ύπαρξη του και πραγματικά βοηθάει αρκετά. Μου φάνηκε αρκετά εύκολο στην χρήση και πολύ εύχρηστο για τον σκοπό του.

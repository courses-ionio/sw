...
### Συστήματα
Το μάθηματα αυτό ασχολήθηκε κυρίως με τα συστήματα και μας έδωσε γνώσεις ως προς αυτά. Σε προσωπικό επίπεδο ασχολήθηκα πολύ με κονσόλες(κυρίως της Nintendo) ως προς τα λογισμικά τους. Έτσι έμαθα αρκετά πράγματα προς αυτά και τον τρόπο που λείτουργουν όπως και την ιστορία τους.

### Linux 
Ένα μεγάλο κομμάτι του μαθήματος περιήχε την αλληλεπίδραση μας με linux. Αυτό μου έδωσε την ευκαιρία μετά από αρκετή έρευνα να μπορώ να περιηθώ σε αυτά και να τα χρησιμοποιώ σε ένα ικανοποιητικό επίπεδο. Έμαθα να χρησιμοποιώ και συστήματα που χρησιμοποιούν `systemd` όπως τα `arch linux` αλλά και συστήματα χωρίς αυτό όπως τα `kiss linux`.

### Github
Το Github θεωρείται το social media των προγραμματιστών και προσωπικά δεν το είχα χρησιμοποιήσει παλαιότερα και μπορώ να πω ότι μου φάνηκε πάρα πολύ ενδιαφέρον ως ένα μέρος όπου προγραμματιστές μπορούν να επικοινωνούν ο ένας με τον αλλόν και να ανταλλάζουν κώδικα. Όπως επίσης και ένα μέρος που σου δίνει ιδέες και σε βοηθαεί σε ότι πρόβλημα μπορείς να αντιμετωπίσεις σε προγραμματιστικό επίπεδο. Τέλος βοηθάει αρκέτα το σύστημα των pull request όπου εμπεριέχει βοήθαει αρκέτα στο να δείξεις την δουλειά σου σε κάποιον και σε ερασιτεχνικό και σε επαγγελματικό επίπεδο, όπως άλλωστε μας δείχνει και αυτή η εργασία.

### Netlify
Μου δώθηκε και η ευκαιρία να γνωρίσω ένα site όπως το netlify. Μπόρω να πω ότι δεν ήξερα την ύπαρξει του και πραγματικά βοηθάει αρκετά. Μου φάνηκε αρκετά εύκολο στην χρήση και πολύ ευχρήστο για τον σκοπό του.

### Συμπέρασμα
Όπως φαίνεται και από τα παραπάνω το μάθημα αυτό με βοήθησε όχι μόνο να πετύχω τους στόχους μου αλλά πιστεύω ότι με βοήθησε αρκέτα να καταλαβώ την λειτουργία ενός υπολογιστή όπως και την ιστορία του. Όπως και επίσης πως τα συστήματα τον μετέτρεψαν σε ένα πιο εύχρηστο εργαλείο. 

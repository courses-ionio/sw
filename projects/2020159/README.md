...
## 9ο Παραδοτέο
Έχοντας μιλήσει προηγουμένως για τον Vim, θεώρησα πως το λογικό επόμενο βήμα είναι να γράψω για τον δημιουργό του, τον Bram Moolenaar και το έργο του στον τομέα της πληροφορικής.

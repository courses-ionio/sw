...
| [7](https://github.com/AlexIoanP2020159/sw/blob/2020159/projects/2020159/README.md) | Συμμετοχικό περιεχόμενο B1 | [Π2020159 - 7ο Παραδοτέο](https://github.com/courses-ionio/sw/discussions/1532) | Προσθήκη ενός ακόμη θέματος εντός του netlify έγινε με ευκολία λόγω συνήθειας με την διαδικασία  |
| 8 | Κατασκευή του βιβλίου Β2 (συνεργατικά) | | |
| 9 | Συμμετοχικό περιεχόμενο B2 | | Συγκραφή βιογραφίας σχετικά με τον Bram Moolenaar |
| 10 | Τελική αναφορά* | | |

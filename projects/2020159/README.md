...
| [8](https://github.com/AlexIoanP2020159/sw/tree/2020159/projects/2020159#8%CE%BF-%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%AD%CE%BF) | Κατασκευή του βιβλίου Β2 (συνεργατικά) | | Κατασκευή του βιβλίου σε HTML |
| [9](https://github.com/AlexIoanP2020159/sw/tree/2020159/projects/2020159#9%CE%BF-%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%AD%CE%BF) | Συμμετοχικό περιεχόμενο B2 | | Συγκραφή βιογραφίας σχετικά με τον Bram Moolenaar |
| [10](https://github.com/AlexIoanP2020159/sw/tree/2020159/projects/2020159#10%CE%BF-%CF%80%CE%B1%CF%81%CE%B1%CE%B4%CE%BF%CF%84%CE%AD%CE%BF) | Τελική αναφορά* | | Συγγραφής μιας τελικής "σύνοψης" των στόχων μου και της επίτευξής τους |
...
## 10ο Παραδοτέο
Εντός του μαθήματος και με την πάροδο του χρόνου, μπορώ να πω πως οι αρχικοί μου στόχοι σχετικά με αυτό άλλαξαν κάπως (σε σχέση με αυτούς που είχα θέσει αρχικά πάντα). Σε πρώτη φάση και όπως είναι προφανές, εξοικιώθηκα ακόμη περισσότερο με το github ως πλατφόρμα και πλέον η χρήση της πλατφόρμας μου φαίνεται "οικεία", καθώς βλέπω τα πολλά θετικά που προσφέρει στην ομαδική αλλά και ατομική ανάπτυξη οποιουδήποτε project ανεξαρτήτου κλίμακας. Επιπλέον, πιστεύω πως κατέλειξα να δίχνω περισσότερη έμφαση σε άλλους τομείς του μαθήματος από τους αναμενόμενους, υιοθετώντας χάρη σε αυτό ένα πιο "κριτικό" σκεπτικό απέναντι στην τεχνολογία γενικότερα και αναζητώντας μια ικανοποιητικότερη προσωπική λύση 
στα προβλήματα που με αφορούν αντί να ενστερνίζομαι τις πιο διαδεδομένες για χαρή της προσωρινής βολικότητας. Τέλος, ιδιαίτερα πιο ενδιαφέρουσα μου φάνηκε αυτή την φορά και η χρήση του netlify για την κατασκευή ιστοσελίδας, όχι απαραίτητα για μια ευρεία χρήση, αλλά και για πράγματα όπως αρχειοθέτηση.

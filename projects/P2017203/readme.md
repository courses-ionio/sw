...
##### Το αποθετήριο της ιστοσελίδας του μαθήματος είναι σε [αυτ΄ό](https://github.com/mibook/gr) το link.
##### Η ιστοσελίδα β΄ιβλίου του μα΄θήματος είναι σε [αυτό](https://www.mibook.org/) το link.
##### To προσωπικό αποθετήριο της ιστοσελίδας του μαθήματος είναι σε [αυτό](https://github.com/p17kagk/gr) το link.
#### H προσωπικ΄ή ιστοσελίδα βιβλίου του μαθήματος είναι σε [αυτό](https://p17kagk.github.io/gr/) το link.
#
